...
| **andoque (gente del hacha)** | reescrita entera el 2026-09-18: once de las catorce fichas declaraban como fuente narrativa la portada de Google Books del libro de 1984 y se publicaron desde su índice; se desmontó la plantilla que daba a las catorce los mismos párrafos de Historia, Versiones y Similitudes y se sacó de los catorce Relatos el descargo metodológico de 96 palabras. Las **oraciones repetidas entre fichas bajaron del 61 % al 0,3 %** (registro en `content/editorial/andoque/`) | completa 2026-09-18: de 7 URLs entre las catorce —de las que sólo una contenía narración andoque— a 19 obras y 8-10 fuentes por mito; retiradas la portada de Google Books, la ficha de Open Library, el registro de Minciencias y una página del IGAC caída que citaban las catorce | sí, verificado en vivo en las 14 rutas |
| **panán (pueblo de los Pastos)** | reescrita entera el 2026-09-19: los dieciséis slugs eran las secciones del capítulo 4 de una tesis de 2016, con sus erratas; se desmontó la plantilla —que vivía en `records.mjs` como tres funciones, no en el constructor— y las **oraciones repetidas entre fichas bajaron del 29,2 % al 0 %**. Las dieciséis nombran ahora a quien contó; antes lo hacían dos (registro en `content/editorial/pananes/`) | completa 2026-09-19: de 10 URLs entre las dieciséis a 24 obras y 7-8 fuentes por mito. Corregidos: tres dragones y no un dragón de tres cabezas, Puenayán y no «Puednayán», la entundada como verbo y no como la Tunda del Pacífico; publicado el desacuerdo sobre María Panana entre Rappaport y el archivo del cabildo; retirada una bitácora anónima | sí, verificado en vivo en las 16 rutas |
| **bloque amazónico** (desana 8, tucano 7, barasana 6, ticuna 6, makaguán 3, sikuani 10) | reescritas enteras el 2026-09-19 sobre sus propios primarios, sin compartir una frase entre ellas. Las seis tenían el mismo molde —entre el 48,7 % y el 53,8 % de sus oraciones repetidas dentro de cada comunidad— y **las seis bajan a 0 %**. El eje se movió del etnógrafo a quienes narran: los desana y los barasana que firman sus libros, Marcos Sierra en tucano, Dolores Noé y Augusto Coello en ticuna, Gregorio Flórez en makaguán, Carmen Rojas y Tiberio Nusalia en sikuani | completa 2026-09-19: de 7-10 URLs por comunidad a 5-16 obras propias por ficha; retiradas las muertas (la ONIC entera, el Museu do Índio tras autenticación, un diagnóstico del Mininterior cuyo PDF ya no existe) y las que ninguna ficha usaba | sí, verificado en vivo en las 40 rutas |
| **bloque B/C/D** (u'wa 11, zenú 7, misak 7, barí 6, quillacingas 6, wounaan 5, afro y africano 5, quimbaya 3, yucuna 2, awá 2, eperara 2, umbra 2, ansermas 2, yukpa 2, cuycuyes 2, y uno cada uno emberá, nɨkak, pirsa, ufaina y yagua) | reescritas enteras el 2026-09-19. Seis de los siete slugs misak eran los seis títulos de un libro infantil de 1980 con narrador ficticio; la cosmogonía u'wa que publicábamos la compuso un analista junguiano reordenando a Osborn según von Franz; el corpus barí llevaba años en línea sin abrirse (Castillo 1980, 296 pp., diecisiete informantes nombrados); y tres fichas bibliográficas yukpa describían obras que no existen con ese título, autor o contenido. Cero oraciones repetidas entre fichas de una misma comunidad | completa 2026-09-19: reparto ficha a ficha en las veinte, cero bloqueos en la auditoría. El reparto en bloque tenía tres escondites: la lista dentro del `pick`, el bloque compartido dentro del constructor y el `define` llamando al `pick` sin argumentos | sí, verificado en vivo en las 21 rutas de comunidad |
| resto (5 comunidades, 94 mitos) + mestizo 184 + mixto 69 | completa | pendiente | — |

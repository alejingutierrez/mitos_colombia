# Inventario del ciclo caribe-mestizo-final (70 fichas)

Subciclos tal como los declara `editorial/caribe-mestizo-final/catalog.mjs`.
El `core` es el resumen heredado, NO verificado: es el punto de partida, no la verdad.

## martinez — 33 fichas

**Marco heredado:** recreación literaria cartagenera de Eustorgio Martínez Fajardo

- `castellano-viejo` — **Castellano viejo**. El marqués de Villalta intenta decidir el futuro de Mariana; la pareja altera las apariencias para forzar una boda y el desenlace convierte los celos de Manuel en ruina. _(límite declarado: El engaño amoroso, el control paterno y la posterior violencia celosa no se romantizan.)_
- `por-la-boca-muere-el-pez` — **Por la boca muere el pez**. Domingo da Cunha, zapatero portugués de lengua irreverente, enfrenta un proceso inquisitorial después de que bromas y blasfemias atribuidas llegan a sus acusadores. _(límite declarado: El proceso y la condena pertenecen a la reconstrucción literaria mientras no exista un expediente colonial identificado.)_
- `a-dios-rogando-y-con-el-mazo-dando` — **A Dios rogando y con el mazo dando**. Juan Pérez parece morir y revive cuando el hisopo de una disputa devocional lo golpea, en una sátira de rivalidades religiosas y explicaciones milagrosas. _(límite declarado: La recuperación no se presenta como evidencia médica ni milagro comprobado.)_
...
- `mona-mona` — **Mona, Mona**. La pieza atribuye a una revelación sobrenatural un conflicto de muerte, secreto y justicia en un entorno palenquero representado por el autor. _(límite declarado: No se usa la voz literaria como etnografía de Palenque ni se repiten generalizaciones raciales del original.)_
...
- `celos-de-esclavo` — **Celos de esclavo**. Una fiesta de La Popa exhibe joyas sobre personas esclavizadas y una rivalidad afectiva desemboca en violencia dentro del orden colonial. _(límite declarado: La esclavitud se nombra como violencia y las personas esclavizadas no se reducen a decoración ni propiedad.)_
...
- `al-convento` — **Al convento**. En la Cartagena de 1811, una joven enfrenta la imposición del convento mientras afecto, honor familiar y causa política compiten por decidir su vida. _(límite declarado: La reclusión impuesta y el control del matrimonio no se presentan como decisiones libres.)_
...
**Marco heredado:** cuento popular costeño publicado por Manuel Zapata Olivella
...
- `quien-manda-mas-en-casa` — **Quién manda más en casa**. Una discusión sobre autoridad doméstica termina demostrando que las decisiones reales no coinciden con las declaraciones públicas de poder. _(límite declarado: La pieza se lee como sátira de roles de género, no como regla sobre todos los hogares costeños.)_

## list — 3 fichas

**Marco heredado:** cuento oral afrocaribeño registrado por George List
...
- `conejo-y-los-hijos-de-tia-tigra` — **Tío Conejo y los siete hijos de Tía Tigra**. Conejo acepta cuidar a siete cachorros de Tigra, los engaña uno a uno y desata una persecución de venganza. _(límite declarado: La fuente de George List registra siete hijos, no cinco como decía la versión heredada.)_

## unresolved — 13 fichas

**Marco heredado:** versión heredada sin fuente primaria exacta localizada

- `la-mina-de-oro-en-el-infierno` — **La mina de oro en el infierno**. La versión heredada hace que Jaime Restrepo, presentado como hombre de Marinilla, engañe a varios cachacos en el cielo con la noticia de una mina de oro en el infierno. _(límite declarado: No apareció una fuente que sostenga la adscripción a Córdoba; los estereotipos regionales se atribuyen al chiste.)_
- `los-tres-curas-enamorados` — **Los tres curas enamorados**. La versión heredada muestra a una mujer y a su esposo engañando a tres sacerdotes enamorados y ocultándolos mediante nombres simbólicos y un árbol. _(límite declarado: Se documenta una familia internacional de cuentos semejantes, no esta versión cordobesa exacta.)_
- `el-desayuno-del-indio` — **El desayuno del indio**. La versión heredada enfrenta a un hombre llamado de forma genérica “el indio” con un sacerdote; el primero resuelve mediante agudeza una prueba ligada al desayuno. _(límite declarado: La etiqueta racializante se conserva solo para explicar el título heredado y no identifica un pueblo indígena.)_
- `la-confesion` — **La confesión**. La versión heredada lleva a una joven al confesionario, donde un sacerdote usa eufemismos corporales con intención sexual y abusa de su autoridad. _(límite declarado: El acoso clerical no se trata como seducción ni se reproduce con detalle explícito.)_
...
- `el-paisa-y-el-gringo` — **El paisa y el gringo**. La versión heredada ocurre en Antioquia y construye una broma entre un paisa y un extranjero a partir de expresiones locales durante una fiesta. _(límite declarado: El propio escenario contradice una procedencia cordobesa segura; la ruta se conserva sin trasladarla hasta hallar su fuente exacta.)_
...
## buenaventura — 1 fichas

**Marco heredado:** adaptación teatral de tradición oral asociada con Enrique Buenaventura

- `tio-conejo-zapatero` — **Tío Conejo zapatero**. En Sábado de Gloria, Conejo promete zapatos que no entrega y desvía cada reclamo hacia otro personaje hasta formar una cadena de persecución. _(límite declarado: La adaptación documentada de Enrique Buenaventura se vincula con tradición oral del Pacífico; la localización heredada en Cotorra sigue sin fuente exacta.)_

## otero — 3 fichas

**Marco heredado:** leyenda histórica firmada por Enrique Otero D’Costa

- `el-castellano-de-san-juan` — **El castellano de San Juan**. Otero D’Costa sitúa en 1629 el ataque de Hanspater al castillo de San Juan; Nufio de los Santos engaña a los sitiadores arrojando comida para fingir abundancia. _(límite declarado: Crónicas y nombres históricos crean el marco, pero los diálogos y la estratagema requieren corroboración separada.)_
- `las-clavelinas` — **Las clavelinas**. Una joven esclavizada llamada Yariva ofrece clavelinas a Pedro Claver; después de la muerte del jesuita, la flor pierde su aroma dentro de la explicación legendaria. _(límite declarado: La esclavitud se nombra como violencia y el episodio no prueba una propiedad botánica de la flor.)_
- `genus-irritable-vatum` — **Genus irritabile vatum**. Una campaña colonial contra habitantes de El Carbón termina convertida en intercambio de versos y sátira entre Pedro Chiquillo y los expedicionarios. _(límite declarado: La voz de Otero reproduce lenguaje colonial ofensivo y no constituye testimonio indígena ni crónica neutral.)_

## morgan — 1 fichas

**Marco heredado:** leyenda raizal e isleña sobre un tesoro no hallado

- `el-tesoro-de-morgan` — **El tesoro de Morgan**. Luces, mapas y escondites conducen hacia un supuesto tesoro de Henry Morgan en el archipiélago; cada búsqueda amplía el relato sin producir una prueba material concluyente. _(límite declarado: La actividad histórica del corsario no demuestra que enterrara un tesoro en la Cueva de Morgan o Providencia.)_

## francisco — 1 fichas

**Marco heredado:** leyenda vallenata del juglar que vence al diablo

- `francisco-el-hombre` — **Francisco el Hombre**. Un juglar se encuentra de noche con un adversario sobrenatural y vence el duelo de acordeón al cantar una oración; la leyenda se asocia con Francisco Antonio Moscote. _(límite declarado: La identidad, las fechas y el Credo invertido varían; no se ofrecen como ritual de protección.)_

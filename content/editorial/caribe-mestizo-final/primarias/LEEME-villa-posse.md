...
1993. ISBN 9978-60-005-1 (tomo II).
...
>
> Esta selección de cuentos y leyendas de Cartagena hacen parte de otros
> estudios que el autor ha realizado sobre el folclor de su ciudad natal. En
> esta publicación, el autor recoge una serie de narraciones de la tradición
> popular oral de Cartagena. **El material de los textos está elaborado
> literariamente**, para una mejor comprensión de la narración.

Con eso, las fichas pueden decir de dónde sale el relato, con qué paginación
original (pp. 25-177 de la edición de 1948) y por qué se lee como literatura
de autor y no como transcripción.

## Dos discrepancias que van a `versiones`, no se funden

- **El editor.** Villa Posse escribe «Editorial **Nuevo Mundo**»; las fichas
  catalográficas de la Biblioteca Nacional dicen «**Mundo Nuevo**». No se
  decide aquí: se declara quién dice cada cosa.
- **La edición.** Villa Posse cita la de 1948. La Biblioteca Nacional cataloga
  dos, la de 1946 (Tipografía Esfuerzo, 230 pp., con fotografías) y la de 1948
  (222 pp.), **las dos declaradas «2.ª ed.» y sin primera conocida**.

## Cómo se llegó aquí, que es la parte útil

El módulo citaba esta obra como `villaFull` con el host **`flacso.org.ec`**,
que es NXDOMAIN, y un agente la dio por muerta. El host bueno es
**`flacso.edu.ec`**, y además **sólo responde por HTTPS**: por `http://` la
conexión se rechaza. Dos erratas de una letra y un esquema tuvieron treinta y
tres fichas bloqueadas.

No confundir con `biblio.flacsoandes.edu.ec`, que es otro servidor y sí está
tras una pantalla que pide confirmar que uno es persona.

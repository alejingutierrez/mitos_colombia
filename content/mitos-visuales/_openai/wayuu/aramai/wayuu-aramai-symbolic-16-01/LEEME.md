...
- Puerta editorial: El usuario autoriza rehacer sólo la cuadrada como símbolo y consolidar aprendizajes. Resultado pendiente de revisión editorial..
...
"$IMAGEGEN_PYTHON" /Users/alegut/.codex/skills/.system/imagegen/scripts/image_gen.py generate \
  --model gpt-image-2 \
  --prompt-file content/mitos-visuales/_openai/wayuu/aramai/wayuu-aramai-symbolic-16-01/prompts/huella.prompt.txt \
  --size 1024x1024 --quality medium --output-format jpeg --no-augment \
  --out output/imagegen/wayuu/triptychs/wayuu-aramai-symbolic-16-01/huella.jpeg

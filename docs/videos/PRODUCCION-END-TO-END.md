...
|---|------|----------------------|-------|-------|-------|--------|------|-------|-------|-------|-------|
| 1 | **Bochica v4** | `el-castigo-de-chibchachum-y-bochica` (+coda de `castigo-y-redencion-de-chibchacum`) | ✅ | ✅ | ✅ | ✅ | ✅ | 19/19 (últ. 22:01) | — | fase-6 @ codex 2026-08-31 19:49 -05 | `videos/bochica/{plan-v4,movimiento-v4}.json`, `voces-v4-2min/`. Guion aprobado en chat y campo `aprobado` estampado 2026-08-31; c01-c19 descargados y ffprobe 1080×1920/24 fps/5,041667 s; QC visual inicial/mitad/final en verde; primera toma c16 cancelada antes de render por asset deduplicado, relanzada una vez con asset verificado; c19 revalidado una vez por elegibilidad del asset |

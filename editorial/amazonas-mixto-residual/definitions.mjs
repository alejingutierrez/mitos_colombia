import { defineAmazonasMixtoResidualMyth } from "./define-editorial-myth.mjs";
...
En el Llano, Getulio Vargas Barón publicó en 1996 «Los delfines dorados», donde los delfines del Pauto y del Meta son la descendencia de unos amantes perdidos en un remolino. Invierte el motivo: el delfín ya no suplanta al marido, sino que nace de un amor humano.`,
    ...
    sceneVertical:
      "un perro ladra desde un corredor ribereño cuando pasa un visitante sobrio con sombrero; detrás, el reflejo del río revela discretamente la forma de un bufeo y su espiráculo, sin amenaza gráfica",
    researchNotes:
      "RECONSTRUCCIÓN CORAL: usa informantes identificados de 1975, separa observación animal de relato heredado y elimina la seducción romántica como eje obligatorio.",
    seoTitle: "El bufeo de Leticia | Testimonios amazónicos",
    seoDescription:
      "Testimonios de Leticia sobre el bufeo, su forma humana y sus riesgos, revisados sin romantizar coerción ni confundir leyenda y delfín real.",
    focusKeywords: [
      "bufeo de Leticia",
      "delfín rosado leyenda amazónica",
      "testimonios del bufeo",
      "bufeo con sombrero",
      "mitos del río Amazonas",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
    slug: "el-cotomachaco",
...
La Historia natural de Plinio el Viejo junta en un mismo capítulo tres rasgos que aquí conviven: la anfisbena de dos cabezas, el cerastes que atrae a las aves moviendo sus cuernos con el resto del cuerpo escondido, y el jáculo que se lanza desde las ramas.`,
    ...
    sceneVertical:
      "una escopeta abandonada descansa junto a hojas húmedas y huellas interrumpidas; al fondo, entre capas de palmas, dos siluetas de cabeza de serpiente responden al eco de un mono",
    researchNotes:
      "RESTITUCIÓN DOCUMENTAL: conserva las diferencias entre Gladys de Bolívar y Manuel Curitima; cincuenta metros queda como escala narrada, no como dato biológico.",
    seoTitle: "El Cotomachaco | Serpiente de dos cabezas",
    seoDescription:
      "Relato de Leticia sobre el Cotomachaco, boa de dos cabezas que imita al mono coto, reconstruido desde testimonios del Caro y Cuervo de 1975.",
    focusKeywords: [
      "Cotomachaco de Leticia",
      "serpiente de dos cabezas Amazonas",
      "boa que imita al mono coto",
      "leyendas del cananguchal",
      "testimonios Caro y Cuervo Amazonas",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
...
En casa, la niña contó que su hermano la cargaba al pasar el agua y que todos los días le daba frutos del monte. Todavía vive y tiene quince años. Desde entonces su madre no volvió a dejar solos a sus hijos.`,
    ...
    sceneVertical:
      "una figura ambigua casi oculta detrás de un tronco proyecta un rastro imposible, un pie hacia el sendero y otro en dirección contraria, sin rostro monstruoso ni persecución",
    researchNotes:
      "VARIANTE BREVE: conserva pies desiguales, imitación y extravío; no fusiona el episodio literario de Ahuanari ni atribuye comunidad sin evidencia.",
    seoTitle: "El Chuyachaque | Pies desiguales del Amazonas",
    seoDescription:
      "Versión breve de Leticia sobre el Chuyachaque, imitador de voces y huellas desiguales que puede extraviar a quienes siguen su llamado en la selva.",
    focusKeywords: [
      "Chuyachaque del Amazonas",
      "Chullachaqui pies desiguales",
      "mito de Leticia para niños",
      "huellas engañosas en la selva",
      "espíritu imitador amazónico",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
    slug: "madre-de-playa",
...
La Madre de Playa permanece como figura de una frontera cambiante. La playa existe porque el río retrocede y desaparece cuando vuelve a crecer. La música marca esa inestabilidad sin convertirla en hecho comprobable. La prudencia consiste en escuchar desde un lugar seguro y reconocer que una orilla nocturna no ofrece las mismas señales que durante el día.`,
    ...
    sceneVertical:
      "ondas de música recorren verticalmente la arena húmeda hasta una canoa amarrada; la figura acuática ya se interna en el río y solo se distingue su silueta, sin palacio ni costa marina",
    researchNotes:
      "ATRIBUCIÓN LIMITADA: conserva el nombre Angélica Lucas como dato heredado del corpus y restituye playa fluvial, guitarra y medianoche; elimina mar, runas y biografía inventada.",
    seoTitle: "Madre de Playa | Canción del río Amazonas",
    seoDescription:
      "Relato de Leticia sobre la Madre de Playa, figura mitad mujer y mitad pez que toca guitarra a medianoche junto a una playa fluvial amazónica.",
    focusKeywords: [
      "Madre de Playa Amazonas",
      "sirena de río en Leticia",
      "guitarra a medianoche Amazonas",
      "leyenda de playa fluvial",
      "Angélica Lucas Madre de Playa",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
...
Norato, ya hombre del todo, sentó plaza de soldado en Cametá. Allí vivió, sin volver al agua, hasta que murió años más tarde. Pero su nombre no se quedó quieto: bajó por el Tocantins, subió por el Amazonas hasta Óbidos y se extendió por toda la Amazonía, de fiesta en fiesta y de orilla en orilla.`,
    ...
    sceneVertical:
      "Honorato en forma de Cobra Grande emerge de noche mostrando su ojo herido ante dos personas que escuchan desde una canoa, escena de petición de ayuda y no de ataque",
    researchNotes:
      "DESFUSIÓN: centra la versión de Pedro Roque sobre Honorato y su hermana; separa Escape del Vientre Serpiente y José Sangam como entradas originales distintas.",
    seoTitle: "Honorato y la Cobra Grande | Versión de Leticia",
    seoDescription:
      "Versión de Leticia sobre Honorato y su hermana, dos hermanos encantados como Cobras Grandes que combaten mientras él busca recuperar forma humana.",
    focusKeywords: [
      "Honorato Cobra Grande Leticia",
      "Pedro Roque Cobra Grande",
      "hermanos serpiente Amazonas",
      "Cobra Norato versión colombiana",
...
Y así las generaciones de tikunas tuvieron con qué vivir durante siglos.`,
    ...
    sceneVertical:
      "Jau planta una secuencia vertical de tubérculos, semillas y retoños mientras Petapeta señala la tierra; la canasta vacía queda arriba y una chagra naciente abajo",
    researchNotes:
      "TRANSFERENCIA TICUNA: reemplaza la canasta de obreros inventada por el testimonio firmado de Milton Jesús Pinto Linares y separa variantes sensibles.",
    seoTitle: "Petapeta y la canasta de semillas | Mito Ticuna",
    seoDescription:
      "Relato Ticuna de Petapeta, Jau y la canasta de semillas enviada por Yoí, narrado por Milton Jesús Pinto Linares en Puerto Nariño.",
    focusKeywords: [
      "Petapeta mito Ticuna",
      "canasta de semillas de Yoí",
      "Jau robo de los alimentos",
      "Milton Jesús Pinto Linares",
      "mito de los alimentos Ticuna",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
    slug: "la-curupira",
...
Apenas lo dijo, el ruido volvió a salir de debajo del otro mutá. Se quedaron un momento paralizados de miedo. Luego ya no quisieron saber nada más y salieron corriendo de aquel lugar. Nadie vio al que corría debajo de los mutás, pero Bira quedó convencido de que era Curupira, que les estaba metiendo miedo.`,
    ...
    sceneVertical:
      "huellas que apuntan en direcciones contrarias bajan por la composición hasta un río reconocible; los caminantes dejan la persecución y recuperan la orilla",
    researchNotes:
      "RECEPCIÓN TRANSFRONTERIZA: elimina personajes inventados y doctrina uniforme; presenta variación histórica brasileña y límite de la atribución leticiana.",
    seoTitle: "La Curupira | Guardiana variable del Amazonas",
    seoDescription:
      "Historia fronteriza de la Curupira, sus huellas engañosas y variantes brasileñas, revisada sin atribuir una apariencia o doctrina única a la Amazonía.",
    focusKeywords: [
      "Curupira frontera amazónica",
      "Curupira pies invertidos",
      "leyenda brasileña en Leticia",
      "guardiana del bosque amazónico",
      "variantes orales del Curupira",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
...
Tiempo después, en una fiesta, el marido llegó con máscara y paja atada a la cabeza, cantando: «Aquí viene la que abandoné bajo los monos coatá». Cimidyue encendió un poco de resina, le pidió ver la máscara y arrojó la llama a la paja seca. Él siguió bailando hasta que brotó el fuego; corrió fuera sin poder quitarse el traje de tururí, y el calor le reventó el vientre. Con su sangre se tiñó las plumas el pájaro pare'ne.`,
    ...
    sceneVertical:
      "una libélula roja cruza sobre el ancho Solimões hacia una plantación donde el padre y su familia levantan la vista; la mariposa azul queda en la orilla opuesta",
    researchNotes:
      "DESFUSIÓN Y TRANSFERENCIA TICUNA: retira por completo el ciclo de Ngutapa, corrige la protagonista a Chimuya-e y declara la mediación etnográfica de 1952.",
    seoTitle: "Los caminos de Chimuya-e | Relato Ticuna",
    seoDescription:
      "Relato Ticuna de Chimuya-e: abandonada entre monos, recibe ayuda de una tortuga y una mariposa, cruza el Solimões y vuelve con su familia.",
    focusKeywords: [
      "Chimuya-e relato Ticuna",
      "Cimidyue The Tukuna",
      "mujer libélula Solimões",
      "tortuga y mariposa Morpho",
      "corrección Ngutapa Chimuiyae",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
    slug: "yacuruna",
...
Por eso, para que la gente del agua no se acerque, se lleva ajo en el bolsillo, se frotan los remos con ají o con ajo y se carga una cruz en el pecho. Cuando el peligro de ser robado está cerca, se reza. Como son demonios, huyen.`,
    ...
    sceneVertical:
      "desde una orilla alta, una joven llama a su familia mientras la canoa aparente revela gradualmente un caimán y una cuerda se convierte en boa; sin secuestro ni erotización",
    researchNotes:
      "RECEPCIÓN PERUANA DECLARADA: centra la versión escolar de Iquitos, elimina la deificación universal y el estereotipo menstrual, y no fuerza atribución Yagua o colombiana.",
    seoTitle: "Yacuruna | Habitante del agua en Iquitos",
    seoDescription:
      "Versión amazónica de Iquitos sobre Yacuruna, ser de apariencia humana que viaja sobre un caimán negro y habita un mundo bajo el agua.",
    focusKeywords: [
      "Yacuruna de Iquitos",
      "ser humano del agua amazónico",
      "Yacuruna caimán negro",
      "mundo subacuático amazónico",
      "leyenda peruana Yacu Runa",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
    slug: "chuya-chaqui",
...
El desenlace no afirma que el bosque mienta. Muestra que una señal culturalmente reconocible también puede ser imitada y que, cuando el entorno cambia, detenerse juntos puede ser más seguro que seguir la promesa de una voz aislada.`,
    ...
    sceneVertical:
      "al amanecer, huellas desiguales se cruzan con una quebrada reconocible mientras el grupo deja atrás las ondas del falso maguaré y recupera el camino a Ahuanari",
    researchNotes:
      "OBRA FIRMADA Y RUTA DISTINTA: conserva Ahuanari, tormenta y falso maguaré de Hugo Niño; relaciona pero no fusiona el Chuyachaque breve.",
    seoTitle: "Chuya-Chaqui y el falso maguaré | Hugo Niño",
    seoDescription:
      "Reescritura amazónica de Hugo Niño: cazadores de Ahuanari siguen un falso maguaré durante una tormenta y reconocen al Chuya-Chaqui.",
    focusKeywords: [
      "Chuya Chaqui Hugo Niño",
      "falso maguaré Ahuanari",
      "Chullachaqui cazadores Amazonas",
      "Primitivos relatos contados otra vez",
      "tormenta y extravío amazónico",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
...
Los nombres de afluentes y la explicación de Boupé que aparecían en la página anterior no se repiten como hechos históricos. Tampoco se llama vikinga a la expedición ni se equipara al joven con Ícaro. El relato habla de flotación, ensayo, riesgo y retorno dentro del marco escrito por Solarte.`,
    ...
    sceneVertical:
      "en una gran balsa a la deriva, el joven señala pequeños animales alojados en las hendiduras de las palmas mientras la tripulación gira la embarcación hacia un río de regreso",
    researchNotes:
      "LITERATURA MEDIADA: conserva la secuencia de Solarte, declara solo cultura Vaupés y evita atribuirla a Tucano, Tanimuka o una comunidad no documentada.",
    seoTitle: "El hijo de Tuhixana | Balsa del Vaupés",
    seoDescription:
      "Reescritura de Fernando Solarte sobre el hijo de Tuhixana, el descubrimiento de troncos flotantes y el viaje de una balsa que consigue regresar.",
    focusKeywords: [
      "hijo de Tuhixana",
      "balsa de palmas Vaupés",
      "Fernando Solarte leyendas indígenas",
      "relato de navegación amazónica",
      "cultura Vaupés mito literario",
    ],
  }),
  defineAmazonasMixtoResidualMyth({
...
Entre los ticuna, el «Origen de Metare» que Dolores Noé, de Ventura, y Jorge Santamaría Fidelis, de Caña Brava, contaron para las «Historias de los abuelos de Moruapü» (2000, pp. 61-64) dice que una tía guarda el agua purificada en un estantillo tapado con cera. Metare finge que unas hormigas le picaron los ojos para saber dónde la esconde, y después vuelve volando, transformado en pájaro, y se la lleva en el pico. El depósito oculto en un poste y el sobrino que espía convertido en animal alado se repiten, pero allí el agua cura los ojos y no forma ríos.`,
    ...
    sceneVertical:
      "los cuatro recipientes se abren y corrientes azules con peces descienden por la composición hasta formar un río; la comunidad observa desde ambas orillas y La Tía queda a distancia",
    researchNotes:
      "TRANSFERENCIA UFAINA/TANIMUKA: conserva la reescritura de La Tía y declara a Solarte; no la fusiona con el ciclo directo de Guaraná Tanimuka sobre el Apaporis.",
    seoTitle: "La Tía, el agua y los peces | Relato Tanimuka",
    seoDescription:
      "Reescritura Tanimuka de Fernando Solarte: La Tía oculta agua y peces en cuatro recipientes hasta que un joven revela y libera la reserva.",
    focusKeywords: [
      "La Tía relato Tanimuka",
      "descubrimiento del agua y peces",
      "Fernando Solarte Tainimuka",
      "cuatro recipientes de agua",
      "mito Ufaina del río",
    ],
  }),
];

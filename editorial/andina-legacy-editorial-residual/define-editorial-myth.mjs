import { buildAndinaLegacyEditorialResidualMyth } from "./build-editorial-myth.mjs";
import { pickAndinaLegacyEditorialResidualSources } from "./sources.mjs";

export function defineAndinaLegacyEditorialResidualMyth(input) {
  ...
  const selectedSources = pickAndinaLegacyEditorialResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildAndinaLegacyEditorialResidualMyth({
    ...input,

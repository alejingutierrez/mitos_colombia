import { defineAndinaVariosMestizoResidualMyth } from "./define-editorial-myth.mjs";
...
Y la ficha del libro de 2004, con su animero de Marquetalia que ve a la mujer encadenada pidiendo agua, conserva la iconografía de las estampas del Ánima Sola que circulan en las iglesias y los hogares campesinos.`,
    ...
    sceneVertical:
      "altar doméstico sencillo visto en vertical con una estampa anónima del Ánima Sola, un vaso de agua y una vela, mientras varias manos dejan nombres de difuntos sin representar un rito oficial ni una identidad histórica",
    researchNotes:
      "RECLASIFICACIÓN DOCUMENTAL: conserva la nota de Marquetalia como narración del bestiario de 2004 y documenta por separado devoción popular, doctrina católica y antecedente literario.",
    seoTitle: "El Ánima Sola: devoción y relato de Marquetalia",
    seoDescription:
      "Revisión del Ánima Sola: devoción por las almas olvidadas, nota literaria de Marquetalia, contexto antropológico y límites históricos.",
    focusKeywords: [
      "El Ánima Sola",
      "Ánima Sola en Colombia",
      "animero de Marquetalia",
...
En Boyacá, el Cucacuy de Javier Ocampo López es un hombre desnudo que sale de noche a calentarse en las parrillas donde todavía queda brasa. Los tres espantos rondan el mismo lugar de la casa campesina, el fogón, y lo hacen en la hora en que la familia ya se retiró.`,
    ...
    sceneVertical:
      "sendero cafetero vertical al amanecer, huellas llegan desde una cocina rural hasta el monte y la silueta de la Colmillona se aleja con comida en las manos, sin persecución ni violencia",
    researchNotes:
      "DESAMBIGUACIÓN: restituye la visitante de fogones, declara el diario de Agustín Moreno como marco literario de 2004 y separa a Colmillona, Muelona y Cabellona.",
    seoTitle: "La Vieja Colmillona: visitante de los fogones",
    seoDescription:
      "Leyenda revisada de la Vieja Colmillona: fogones campesinos, diario literario de 2004, variantes regionales y diferencia frente a la Muelona.",
    focusKeywords: [
      "La Vieja Colmillona",
      "leyenda de la Colmillona",
      "Colmillona de Aguadas",
      "espantos de Antioquia",
      "Colmillona y Muelona",
    ],
  }),

  defineAndinaVariosMestizoResidualMyth({
    slug: "la-nina-de-la-carta",
    title: "La Niña de la Carta: tres relatos, no un expediente",
    excerpt:
      "Una pasajera que desaparece, una carta de mal agüero y una búsqueda de sepultura son versiones distintas reunidas bajo el mismo nombre.",
    tags: ["muerte", "fantasmas", "carretera", "misterio"],
    mito: `La Niña de la Carta aparece en caminos de Antioquia y el Eje Cafetero como una muchacha vestida de blanco, con traje o velo de primera comunión y una carta en la mano. Pide ayuda a conductores que viajan de noche. Cuando alguien se detiene, puede subir al vehículo, dar un nombre o una dirección y desaparecer antes de llegar. En otras narraciones deja la carta como única prueba del encuentro. El susto, la distracción o una curva peligrosa convierten la aparición en advertencia vial.

El libro de 2004 construye su episodio principal como un fragmento de una supuesta Enciclopedia de las ciencias ocultas en Colombia, dentro del capítulo dedicado a “Jesusita Bautista, una médium del otro mundo”. La fecha impresa es el 1 de noviembre de 1963. El texto dice que un sindicato de transportadores de Itagüí solicitó ayuda por varios accidentes, que participó un médico de la Universidad de Antioquia y que durante una sesión se materializó la niña. Después, una carta habría conducido a su nombre y a una tumba en el cementerio de Itagüí.

Esos nombres, institución y episodio no cuentan con corroboración independiente en el dossier. La página no reproduce membrete, acta universitaria, noticia o registro del cementerio. Su forma enciclopédica pertenece al mismo bestiario que presenta diarios encontrados y testimonios en trance. Por eso esta revisión narra lo que afirma la edición, pero no lo transforma en investigación médica de 1963. También corrige el año 1965 que mostraba la página antigua.

La ficha técnica del volumen amplía el motivo a carreteras próximas a Heliconia, Armenia e Itagüí y a departamentos del antiguo eje cafetero. Allí la joven pide transporte, desaparece y puede provocar un accidente. La herida del cuello y la carta con datos funerarios funcionan como señales de identidad dentro de esa versión; no se desarrollan con detalle gráfico.

El mismo nombre circula con argumentos diferentes. Una colección de José Luis Díaz-Granados incluye otra Niña de la Carta; un cuento de Humberto Senegal alude a una niña que toca una puerta y entrega un mensaje que anuncia muerte o desgracia. Un audio de 2022 cuenta una búsqueda de sepultura. Son reelaboraciones documentables, pero no capítulos de la misma vida. La página conserva su diversidad y elimina la certeza falsa de un expediente único.`,
    historia: `La entrada del bestiario de 2004 ocupa las páginas impresas 61 y 62. El facsímil confirma el encabezado, la fecha de 1963 y el formato de informe ocultista. Open Library y los catálogos públicos prueban que el texto forma parte de una obra literaria e ilustrada de 103 páginas, no de una revista científica ni de un archivo de la Universidad de Antioquia.

La página anterior del sitio repetía como hechos a Jesusita Bautista, el médico Javier Restrepo, el dirigente Salvador Cochero, el sindicato y la materialización. También cambiaba la fecha a 1965 y añadía una descripción violenta. La revisión devuelve todos esos elementos a su lugar documental: son afirmaciones internas de la narración de 2004. Al no aparecer confirmación en prensa, catálogos académicos o registros institucionales consultados, no se usan para reconstruir una biografía real.

La Biblioteca Nacional de Colombia cataloga Cuentos y leyendas de Colombia de José Luis Díaz-Granados, publicado en 2013, y menciona una narración con el mismo título. El registro la sitúa entre tradición oral y literatura popular, pero no expone el texto completo; por tanto, acredita circulación editorial del nombre sin demostrar identidad argumental.

Humberto Senegal incorpora una versión breve en un volumen de la Biblioteca de Autores Quindianos de la Universidad Tecnológica de Pereira. Allí la carta llega a una casa y funciona como anuncio funesto. Un podcast de 2022 difunde una variante donde el mensaje permite encontrar a la niña y darle sepultura. Ambas muestran transformación contemporánea del motivo, aunque la segunda no cita fuente y se maneja como recepción sonora.

En lugar de elegir una versión como verdad histórica, el expediente registra soportes, fechas y diferencias. La categoría sigue siendo mestiza y andina porque la circulación publicada se concentra allí, no porque exista un único pueblo de origen comprobado.`,
    versiones: `La versión vial de la ficha de 2004 presenta a una joven de blanco que pide transporte en carreteras de Antioquia y el Eje Cafetero. Puede desaparecer del vehículo, dejar una carta o provocar que el conductor pierda el control. Heliconia, Armenia e Itagüí aparecen como referencias de circulación, no como tres escenas sucesivas.

El supuesto informe del 1 de noviembre de 1963 añade una sesión mediúmnica, un sindicato de transportadores, un médico y una tumba. Se conserva como marco literario específico del bestiario. No hay evidencia suficiente para atribuirlo a una investigación real ni para corregir sus vacíos con imaginación.

La versión aludida por Humberto Senegal cambia la carretera por la puerta de una casa. Una niña vestida de primera comunión entrega una carta que anuncia muerte o desgracia a quien la recibe. El gesto es oracular y no depende de un viaje en automóvil.

La recepción sonora de 2022 convierte la carta en mensaje para localizar un cuerpo y obtener sepultura. Aunque mantiene vestido blanco, llanto y carta, añade un crimen familiar no acreditado por las fuentes anteriores. La revisión evita el detalle gráfico y no lo proyecta retrospectivamente sobre 1963. Las tres formas comparten mensajera y papel, pero tienen desenlaces y soportes distintos.`,
    leccion:
      "Una carta compartida no convierte versiones literarias distintas en un solo caso verdadero.",
    similitudes: `La leyenda internacional de la pasajera que desaparece comparte con la versión vial una joven que solicita transporte y se esfuma antes de llegar; la Niña de la Carta colombiana añade el mensaje escrito, el vestido de primera comunión y lugares andinos concretos. La Llorona también aparece como figura femenina que llora cerca de caminos o aguas, pero busca o lamenta hijos y no entrega una carta a conductores. El Ánima Sola pide recuerdo, oración o agua, mientras la Niña solicita viaje, recepción del mensaje o sepultura según la versión. Estas semejanzas describen funciones de aparición y memoria; no prueban un origen común ni un expediente sobrenatural verificable.`,
    sceneHorizontal:
      "carretera montañosa de Antioquia en una noche lluviosa, un conductor detiene un bus antiguo a distancia segura ante una niña vestida de primera comunión que sostiene una carta cerrada, curvas y señales viales visibles",
    sceneVertical:
      "puerta de una casa andina vista en vertical, una carta cerrada queda sobre el umbral mientras la silueta blanca de una niña se aleja por una calle tranquila, sin accidente ni violencia",
    researchNotes:
      "RECLASIFICACIÓN Y VERSIONES: corrige 1965 por 1963, convierte el supuesto informe en marco literario atribuido y separa carretera, carta de mal agüero y búsqueda de sepultura.",
    seoTitle: "La Niña de la Carta: versiones y fuentes",
    seoDescription:
      "Revisión de la Niña de la Carta: aparición vial, supuesto informe de 1963 y variantes literarias diferenciadas, sin convertirlas en hechos históricos.",
    focusKeywords: [
      "La Niña de la Carta",
      "leyenda de la Niña de la Carta",
      "Niña de la Carta en Itagüí",
      "fantasma de carretera Colombia",
      "mitos del Eje Cafetero",
    ],
  }),
...
Y los cuatro cargadores sin cabeza pertenecen a la familia de los espantos acéfalos del mundo hispánico, como el fraile sin cabeza que el libro de Baquero Nariño cuenta entre los mitos andinos llevados al piedemonte llanero. En los dos casos, la falta de cabeza marca a los que ya no son de este mundo.`,
    ...
    sceneVertical:
      "puente de madera sobre un río andino visto en vertical, vecinos sostienen juntos un guando de guadua muy pesado antes de cruzar, con una procesión de luces lejanas y sin caída ni horror gráfico",
    researchNotes:
      "INTEGRACIÓN DE VARIANTES: conserva por separado el trance de Anselmo, la promesa de Chiquinquirá en la fila 399 y el Guando de las filas 419-420; corrige Sara Trista por Sara Tustra.",
    seoTitle: "La Barbacoa del Muerto: versiones del Guando",
    seoDescription:
      "Leyenda revisada de la Barbacoa del Muerto y el Guando: procesiones rurales, tres explicaciones atribuidas, fuentes y límites históricos.",
    focusKeywords: [
      "La Barbacoa del Muerto",
      "leyenda del Guando",
      "barbacoa de guadua",
      "procesión fantasmal colombiana",
      "mitos de Antioquia Grande",
    ],
  }),
...
La figura del ser pequeño que pide una limosna y premia al que da, y castiga al que niega, tiene una larga historia en los cuentos de todo el mundo hispánico, donde el mendigo de apariencia humilde resulta ser un santo o un ser del otro mundo que pone a prueba la caridad del caminante.`,
    ...
    sceneVertical:
      "sendero vertical entre montañas, los muchachos acompañan al viajero cansado y uno toca suavemente su frente mientras pequeñas monedas antiguas quedan en un bolsillo abierto, ambiente alegre y sin amenaza",
    researchNotes:
      "RESTITUCIÓN DEL SUJETO: Los Meneses vuelven a ser el grupo de muchachos-espíritu; el vagabundo de Anserma queda como narrador literario de la nota de 2004.",
    seoTitle: "Los Meneses: muchachos que comen monedas",
    seoDescription:
      "Leyenda revisada de Los Meneses: muchachos-espíritu, monedas, cosquillas, alegría, nota literaria de 2004 y comparación con duendes.",
    focusKeywords: [
      "Los Meneses",
      "leyenda de Los Meneses",
      "muchachos que comen monedas",
      "espíritus de caminos colombianos",
      "mitos de Anserma",
    ],
  }),
];

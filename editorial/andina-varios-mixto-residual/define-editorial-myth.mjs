import { buildAndinaVariosMixtoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickAndinaVariosMixtoResidualSources } from "./sources.mjs";

export function defineAndinaVariosMixtoResidualMyth(input) {
  ...
  const selectedSources = pickAndinaVariosMixtoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildAndinaVariosMixtoResidualEditorialMyth({
    ...input,

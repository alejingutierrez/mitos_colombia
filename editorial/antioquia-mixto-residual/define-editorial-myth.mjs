import { buildAntioquiaMixtoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickAntioquiaMixtoResidualSources } from "./sources.mjs";

export function defineAntioquiaMixtoResidualMyth(input) {
  ...
  const selectedSources = pickAntioquiaMixtoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildAntioquiaMixtoResidualEditorialMyth({
    ...input,

...
import { awaMedia } from "./media.mjs";
import { awaCategoryBySlug } from "./universe.mjs";
...
export function buildAwaEditorialMyth(input) {
  const media = awaMedia[input.slug];
  const categoryPath = awaCategoryBySlug[input.slug];

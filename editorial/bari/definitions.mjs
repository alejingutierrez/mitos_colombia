...
Hay un tercer eco. El sueño, en el material de Castillo, es un viaje corto de la misma clase: el espíritu del que duerme se pasea de noche por la región de los muertos y vuelve al amanecer. Caminar liviano es hacer despierto lo que se hace dormido.`,
    ...
    seoDescription:
      "Lee el relato Barí de un joven guiado por un chigbarí hasta el lugar de los muertos y conoce sus fuentes y mediaciones.",
    focusKeywords: [
      "Caminar liviano Barí",
      "más allá Barí",
      "chigbarí",
      "Taigda Chigbana",
      "cosmología Barí",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena del joven Barí regresando al bohío para narrar el viaje, mientras detrás se elevan siete senderos simbólicos de Ishtana con yuca, arco, estrellas y figuras espirituales; capas planas y quilling dibujado, sin piñas, frailejones, coronas, halos ni símbolos inventados, sin objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `NÚCLEO: viaje guiado, prohibiciones, estación de los muertos, retorno narrativo y muerte.
PROCEDENCIA: registro Barí venezolano compilado por De Armellada y Bentivenga y antologado por Rocha.
CAUTELA: no se presenta como versión localizada en una comunidad colombiana.
GEOGRAFÍA: punto territorial representativo, no localización del más allá.
${visualRule}`,
  },
  {
...
Castillo añade un detalle que la comparación suele perder: lo que los barí trajeron de arriba fueron la caña brava y las semillas. La pérdida del camino es también la pérdida de un intercambio.`,
    ...
    seoDescription:
      "Conoce dos versiones Barí del bejuco que unía Ishtana con la Luna o el cielo y por qué la conexión terminó cortada.",
    focusKeywords: [
      "bejuco entre la Luna y la Tierra",
      "mito Barí de la Luna",
      "Señora de la Luna",
      "Barí bajaron del cielo",
      "cosmología Barí",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena del bejuco recién cortado entre la selva de Ishtana y la Luna que se aleja; algunas figuras quedan arriba junto a aves cóndor y otras miran desde la Tierra, capas recortadas ilustradas y quilling gráfico, sin texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `UNIFICACIÓN: versión de la Señora de la Luna y versión del descenso celeste con gallinazo.
CORRECCIONES: se restituye la condición íntima y se retiran palacio, romance y genealogías inventadas.
NOMBRE: Barí como autodenominación pública; el slug histórico se conserva.
IMÁGENES: la pareja heredada parecía maqueta fotografiada y debe reemplazarse por ilustraciones 2D.
${visualRule}`,
  },
  {
...
Jaramillo Gómez apunta un dato que aleja la lectura ecologista contemporánea: entre los barí el cultivo de la yuca parece una influencia llegada de la Amazonia, y su economía siguió siendo de horticultura móvil y pesca de represa. El agua del relato no es un recurso administrado sino el sitio donde vive otra gente.`,
    ...
    seoDescription:
      "Conoce el relato Barí del árbol que liberó el agua y formó los ríos Catatumbo y de Oro, con sus versiones y fuentes.",
    focusKeywords: [
      "gran árbol de los ríos Barí",
      "origen del río Catatumbo",
      "Iquibocyi río de Oro",
      "Dabogyi",
      "mito Barí del agua",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena después de la caída, ramas del árbol se convierten desde arriba en ríos de papel que atraviesan Ishtana hacia bohíos, peces y un caimán; composición gráfica de capas planas, sin texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `UNIFICACIÓN: caída del árbol gigantesco y versión del tronco que contenía agua.
VOCES: muchacho, anciano y Kokebadou se conservan como variantes, no como personaje único.
TERRITORIO: Dabogyi/Catatumbo e Iquibocyi/Río de Oro.
GEOGRAFÍA: marcador territorial aproximado.
${visualRule}`,
  },
  {
...
Las fases lunares se explican con un sombrero grande y uno chiquito, y las manchas con collares. Frente a las cosmologías que emparejan al Sol y a la Luna como marido y mujer, el material barí insiste en lo contrario: Ñandóu vive con su familia y Chibáig vive sola, y lo que los une es el reparto del trabajo.`,
    ...
    seoDescription:
      "Descubre cómo Ñandóu y Chibáig ocupan las funciones de Sol y Luna y conoce la prueba Barí del collar de tucán.",
    focusKeywords: [
      "Ñandóu y Chibáig",
      "Sol y Luna Barí",
      "collar de tucán",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena del cielo Barí ordenado, Ñandóu arriba como Sol diurno y Chibáig como Luna nocturna separados por una banda de plumas amarillas y negras; abajo, bohío y selva alternan trabajo y sueño, sin texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `NÚCLEO: prueba del collar, elegido subestimado, origen del día y la noche.
NOMBRES: Ñandóu/Nandu y Chibáig/Chibaig según edición.
CAUTELA: la identificación del vidente anónimo con Ñandóu se presenta como variante, no certeza total.
RETIRO: no hay dioses solares clásicos ni tocados panindígenas.
${visualRule}`,
  },
  {
...
Castillo insiste en un punto que las comparaciones suelen borrar: el nombre que Sabaséba impone no es un nombre particular. Barí quiere decir gente, personas. Por eso, cuando a los ancianos se les pregunta si tal o cual personaje mítico era barí, responden que sí, y hay que precisar la pregunta para saber si hablan del grupo étnico.`,
    ...
    seoDescription:
      "Conoce cómo Sabaseba ordenó Ishtana y cómo los primeros Barí surgieron de piñas para aprender oficios y normas.",
    focusKeywords: [
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de los Saimadoyi saliendo de varias piñas y ascendiendo por franjas de oficios —pesca, caza, bohío, tejido y cuidado— bajo Sabaseba y el cielo de Ishtana, sin texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE RECTORA: Mandato de Justicia de Ñatubaiyibarí.
NÚCLEO: Sabaseba ordena Ishtana; la gente sale de piñas y colabora.
VARIANTES: Barira, Basurita/Bakurita y distintos Saimadoyi según publicación.
CONTEXTO: transformaciones animales y Muchú/Mucshura no abren páginas separadas.
${visualRule}`,
  },
  {
...
Castillo advierte contra dos lecturas. Una es la de Jaulin, que interpretó el episodio como memoria de una antropofagia barí; Castillo la considera fuera del contexto sociocultural del grupo. La otra es la del propio relato: los narradores lo cuentan afirmando la superioridad de su gente, y los oyentes lo saben.`,
    ...
    seoDescription:
      "Lee el relato Barí de Sibabió y las cenizas dispersadas, con sus variantes, fuentes y una explicación crítica del lenguaje racial.",
    focusKeywords: [
      "Sibabió y las cenizas",
      "relato Barí de Sibabio",
      "origen de otros pueblos Barí",
      "Sabaseba",
      "memoria Barí",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de cenizas multicolores llevadas por el viento que se convierten en personas y seres del territorio sobre varias franjas de Ishtana; composición respetuosa y no literal, sin cadáver, sin estereotipos de color de piel, sin texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `NÚCLEO: Sibabió, tragedia, quema y dispersión de cenizas.
CAUTELA: contenido de muerte infantil y vocabulario racial; se narra sin sensacionalismo ni jerarquías.
VARIANTES: listas de pueblos, espíritus y animales cambian entre fuentes.
NOMBRE: Sibabio/Sibabió según publicación.
${visualRule}`,
  },
];

export default bariDefinitions;

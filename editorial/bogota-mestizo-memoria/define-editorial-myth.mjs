import { buildBogotaMestizoMemoryEditorialMyth } from "./build-editorial-myth.mjs";
import { pickBogotaMestizoMemorySources } from "./sources.mjs";

export function defineBogotaMestizoMemoryMyth(input) {
  ...
  const selectedSources = pickBogotaMestizoMemorySources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildBogotaMestizoMemoryEditorialMyth({
    ...input,

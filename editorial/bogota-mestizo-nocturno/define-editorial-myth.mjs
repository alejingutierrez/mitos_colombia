import { buildBogotaMestizoNightEditorialMyth } from "./build-editorial-myth.mjs";
import { pickBogotaMestizoNightSources } from "./sources.mjs";

export function defineBogotaMestizoNightMyth(input) {
  ...
  const selectedSources = pickBogotaMestizoNightSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildBogotaMestizoNightEditorialMyth({
    ...input,

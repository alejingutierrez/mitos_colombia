import { buildBoyacaMestizoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickBoyacaMestizoResidualSources } from "./sources.mjs";

export function defineBoyacaMestizoResidualMyth(input) {
  ...
  const selectedSources = pickBoyacaMestizoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildBoyacaMestizoResidualEditorialMyth({
    ...input,

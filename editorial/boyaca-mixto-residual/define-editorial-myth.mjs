import { buildBoyacaMixtoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickBoyacaMixtoResidualSources } from "./sources.mjs";

export function defineBoyacaMixtoResidualMyth(input) {
  ...
  const selectedSources = pickBoyacaMixtoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildBoyacaMixtoResidualEditorialMyth({
    ...input,

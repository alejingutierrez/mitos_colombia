import { defineBoyacaMixtoResidualMyth } from "./define-editorial-myth.mjs";
...
Y las aves hechas de hojas que vuelan son un motivo de figuras que cobran vida. Mayavita las arma con sus manos como Mongatá, su padre, modelaba vasijas: la hija del alfarero hace de la materia muerta un ser que vuela, y ese ser, teñido con su sangre, se convierte en mensajero entre los hombres y el Sol.`,
    ...
    sceneVertical:
      "durante una ceremonia comunitaria junto al lago, dos guacamayas rojas se posan en un árbol y parecen hablar ante la luz de Sua mientras la madre de Mayavita escucha entre las figuras reunidas, sin mostrar sacrificio",
    researchNotes:
      "UNIFICACIÓN Y ATRIBUCIÓN: reúne nueve fragmentos del Excel en una ruta, restituye Mongatá y atribuye la versión consultable a Lilia Montaña sin inventar una cadena oral no documentada.",
    seoTitle: "Mayavita y los mensajeros de los dioses",
    seoDescription:
      "Relato revisado de Mayavita y las guacamayas del lago de Tota, atribuido a Lilia Montaña, con su viaje, caída y regreso como mensajeras de Sua.",
    focusKeywords: [
      "Los mensajeros de los dioses",
      "Mayavita y las guacamayas",
...
El propio Ocampo abre su capítulo con Fu, el espíritu de la laguna de Fúquene que se aparece en forma humana a los obreros del ferrocarril para decirles que invaden su palacio: otra figura del campo boyacense que toma cuerpo de hombre para imponer su ley.`,
    ...
    sceneVertical:
      "camino de Lengupá entre cañaduzales, un cerdo dorado corre bajo la luna con la pequeña silueta de un duende sobre el lomo mientras ondas gráficas del silbido atraviesan la escena, sin persecución humana",
    researchNotes:
      "RESTITUCIÓN DE VARIANTES: separa el hombre del Valle de Tenza y el cerdo con duende de Lengupá, declara el límite colonial y elimina a Antonio Bustamante no corroborado.",
    seoTitle: "El Cucacuy: silbidos y tesoros de Boyacá",
    seoDescription:
      "Leyenda revisada del Cucacuy: hombre silbador en el Valle de Tenza y cerdo con duende en Lengupá, con variantes, fuentes y límites documentales.",
    focusKeywords: [
      "Cucacuy",
      "leyenda del Cucacuy",
      "Cucacuy del Valle de Tenza",
      "silbido del Cucacuy",
      "mitos de Boyacá",
    ],
  }),
...
Ocampo recuerda en esas mismas páginas que Piedrahita habla de una cacica Furatena, dueña de las esmeraldas más finas de Muzo, a quien el zipa Saquezazipa quiso visitar con la comitiva más ostentosa de su reino: el nombre del mito aparece también en la historia de la conquista.`,
    ...
    sceneVertical:
      "figuras de madera emergen vivas del agua en parejas y comienzan a sembrar sobre la ribera, mientras la sombra de Are se desvanece entre las montañas al fondo, sin mostrar una deidad física monumental",
    researchNotes:
      "CORRECCIÓN CULTURAL: restituye la atribución muzo, conserva el núcleo sombra-madera-agua-cultivo y separa las digresiones clásicas e hipótesis migratorias posteriores.",
    seoTitle: "La sombra creadora de Are, mito muzo",
    seoDescription:
      "Mito muzo revisado de Are: la gran sombra que talló figuras humanas en madera y les dio vida junto al río, con fuentes y límites coloniales claros.",
    focusKeywords: [
      "La sombra creadora",
      "Are dios creador muzo",
      "mito de origen muzo",
      "figuras de madera de Are",
      "mitología muzo",
    ],
  }),
...
El segundo lo propone el propio Ocampo cuando cita el Ratnapariska, tratado indio de gemas: la esmeralda nació de la bilis del rey de los dānavas, y Vasuki, rey de las serpientes, la dejó caer dentro de una montaña al huir de sus enemigos. Las dos explicaciones sacan la piedra verde de un cuerpo herido y la guardan en la roca. Pero en la india la gema es botín robado, y en Muzo es el llanto de una mujer.`,
    ...
    sceneVertical:
      "antes de la transformación, Fura sostiene a Tena en un paisaje del Carare mientras Zarbi aparece como una peña azulada separada por un río naciente, escena simbólica y contenida sin mostrar heridas",
    researchNotes:
      "SEPARACIÓN DE CAPAS: distingue la versión local Fura-Tena-Zarbi, la variante de Ocampo, el adoratorio madre-hijo y la cacica histórica; mantiene atribución muzo y enlace con Are.",
    seoTitle: "Fura y Tena: los peñones de Furatena",
    seoDescription:
      "Leyenda muzo revisada de Fura, Tena y Zarbi: peñones, río, esmeraldas y mariposas, con variantes locales y noticias coloniales diferenciadas.",
    focusKeywords: [
      "Fura y Tena",
      "leyenda de Furatena",
      "cerros Fura y Tena",

import { buildCaldasMestizoEditorialMyth } from "./build-editorial-myth.mjs";
import { pickCaldasMestizoSources } from "./sources.mjs";

export function defineCaldasMestizoMyth(input) {
  ...
  const selectedSources = pickCaldasMestizoSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildCaldasMestizoEditorialMyth({
    ...input,

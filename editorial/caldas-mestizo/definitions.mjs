import { defineCaldasMestizoMyth } from "./define-editorial-myth.mjs";
...
Y la mortaja que no deja caminar, recortada de más por la costurera que trabaja en domingo, une dos preceptos que el cuento castiga juntos: guardar el día del Señor y tratar a los muertos con el respeto debido. La canilla que parecía un cirio convierte ese doble descuido en una cicatriz.`,
    ...
    sceneVertical:
      "Ñuá Ulogia junto a su mesa de costura mira por la ventana a Jovita con una mortaja demasiado larga, bajo una noche de domingo",
    researchNotes:
      "REUBICACIÓN Y AUTORÍA: conserva los dos episodios publicados por Otero D’Costa, los identifica como literatura moralizante y corrige Caldas por Santander sin eliminar la URL.",
    seoTitle: "Cuento de ánimas de Otero D’Costa",
    seoDescription:
      "Laurián y Ñuá Ulogia encuentran procesiones de ánimas en dos relatos moralizantes de Enrique Otero D’Costa situados en Santander.",
    focusKeywords: [
      "Cuento de ánimas",
      "Laurián y Ñuá Ulogia",
      "Enrique Otero D’Costa",
      "ánimas de Santander",
      "leyendas de Rionegro Santander",
    ],
  }),
  defineCaldasMestizoMyth({
...
Dentro de la obra del mismo autor, «In illo tempore» mide el honor de otro caballero de la región por lo contrario, por haber cambiado de bando.`,
    ...
    sceneVertical:
      "Rodrigo permanece de frente bajo la luz del amanecer mientras los demás se retiran hacia el caserón, instante simbólico sin heridas visibles",
    researchNotes:
      "FICCIÓN HISTÓRICA CON FRONTERA COLONIAL: restituye el texto firmado y conserva su trama, pero identifica la encomienda y la representación de los pijaos como perspectiva narrativa, no historia neutral.",
    seoTitle: "De frente al sol, leyenda de Chinchiná",
    seoDescription:
      "Relato de Enrique Otero D’Costa sobre una encomienda de Chinchiná en 1592, la resistencia indígena y la muerte de Rodrigo frente al enemigo.",
    focusKeywords: [
      "De frente al sol",
      "Enrique Otero D’Costa",
      "encomienda de Chinchiná",
      "leyendas de Caldas",
      "ficción histórica colonial",
    ],
  }),
  defineCaldasMestizoMyth({
    slug: "el-aserrador",
...
El gigante peludo que acomete a los caminantes reaparece en la región con el nombre de El Patón. Su registro abierto es tardío: una noticia inventada del libro de 2004 y unos textos escolares firmados «Leyenda popular». Allí es un monstruo de película; en el testimonio de Supía es un vecino del monte que deja al aserrador enfermo ocho días y le quita las ganas de caminar de noche.`,
    ...
    sceneVertical:
      "Rafael levanta el farol en La Toma y distingue a distancia una figura velluda de uñas enormes, con una ruta de escape hacia Los Zorros",
    researchNotes:
      "RESTAURACIÓN DEL UÑÓN: corrige el título heredado, conserva la secuencia del testimonio de Rafael Toro y mantiene abierta la explicación alternativa del informante.",
    seoTitle: "Rafael Toro, el aserrador, y el Uñón",
    seoDescription:
      "Leyenda de Supía la Alta en la que el aserrador Rafael Toro huye de una figura velluda y de uñas enormes conocida como el Uñón.",
    focusKeywords: [
      "Rafael Toro aserrador",
      "leyenda del Uñón",
      "mitos de Supía",
      "espantos de Caldas",
      "Hojas Anchas Supía",
...
El viaje por una planta que salve a otro y el fracaso por llegar tarde tienen además un modelo antiguo en Gilgamesh, que baja al fondo del mar por la planta que devuelve la juventud y la pierde en el camino de vuelta.`,
    ...
    sceneVertical:
      "un visitante de la cumbre encuentra a Cumanday sosteniendo las hierbas junto a una grieta, como si el tiempo se hubiera detenido",
    researchNotes:
      "LEYENDA LITERARIA Y LÍMITE DE ATRIBUCIÓN: conserva la trama firmada por Vélez Correa, documenta el nombre geográfico y no convierte la conjetura páez en memoria nasa.",
    seoTitle: "Cumanday y las hierbas del Nevado del Ruiz",
    seoDescription:
      "Leyenda de Fabio Vélez Correa sobre Cumanday, quien cruza el Nevado del Ruiz buscando hierbas para salvar a su esposa y al hijo recién nacido.",
    focusKeywords: [
      "leyenda de Cumanday",
      "Nevado del Ruiz Cumanday",
      "mitos de Caldas",
      "hierbas del nevado",
      "Fabio Vélez Correa",
    ],
...
El libro de 2004 Cuentos de espantos, que se declara ficción, trae un Coco Pelao de los Llanos, distinto del caldense, prueba de que el nombre se aplicó en cada región a espantos muy diversos con la misma función.`,
    ...
    sceneVertical:
      "el calabazo, la vela y la silueta del portador quedan revelados por separado al terminar la broma, sin niños aterrorizados",
    researchNotes:
      "SEPARACIÓN DE MOTIVOS: distingue al Coco incorpóreo de dos escenificaciones riosuceñas y retira la afirmación de un origen africano único no demostrado.",
    seoTitle: "El Coco y los calabazos de Riosucio",
    seoDescription:
      "Historia del Coco sin forma definida y de dos calabazos iluminados usados en Riosucio para asustar caminantes durante la noche.",
    focusKeywords: [
      "Coco de Riosucio",
      "calabazo iluminado",
      "mitos infantiles de Caldas",
      "Tatínez Riosucio",
      "origen del Coco",
    ],
  }),
...
Vélez no dice si tomó el testimonio de un libro o de una entrevista. Su lista de fuentes registra los trabajos de Julián Bueno sobre las creencias del occidente caldense, publicados por la Universidad de Caldas a fines de los años ochenta, que son el origen probable de toda la entrada.`,
    versiones: `Vélez y Bueno dan una sola descripción y un solo testimonio, y esa entrada, breve, es la que fija la figura del Cole-Cabuya en la región de San Lorenzo y Supía la Alta, con fechas y veredas.
...
En el alto oriente caldense, el libro del SENA de 2022 recoge al Perro Negro, que con su sola presencia hace perder el conocimiento. Luis Javier Gallego, de Manzanares, cuenta que salió de noche a esperarlo, y que su compañero cayó inconsciente al llegar a casa. Como el Cole-Cabuya, es un animal negro de la noche que desmaya a quien lo encuentra, aunque el perro no señala ninguna falta ajena.`,
    ...
    sceneVertical:
      "primer plano del Cole-cabuya levantando la cola de fibras frente a una bifurcación entre Llanogrande y La Loma, sin mostrar desmayos",
    researchNotes:
      "NÚCLEO TERRITORIAL Y LECTURA CRÍTICA: conserva cuerpo, cola, lugares y episodio atribuido; identifica la censura del incesto como función social sin reproducirla como verdad comunitaria.",
    seoTitle: "El Cole-cabuya de San Lorenzo y Supía",
    seoDescription:
      "Relato del animal nocturno con cola de cabuya que bloqueaba caminos en San Lorenzo y Supía la Alta y fue usado como figura de censura social.",
    focusKeywords: [
      "Cole-cabuya",
      "mitos de San Lorenzo Caldas",
      "leyendas de Supía",
      "animal con cola de cabuya",
      "espantos de Caldas",
    ],
  }),
  defineCaldasMestizoMyth({
...
La Mano Peluda tunjana de Ocampo López lleva la figura a los conventos y las casas coloniales de Tunja. Allí la mano sale de los muros de la ciudad vieja; en Caldas, de las troneras de los bahareques.`,
    ...
    sceneVertical:
      "el costal, el bastón y una mano que permanece oculta bajo la manta del viejo, vistos desde una ventana sin mostrar secuestro alguno",
    researchNotes:
      "RESTAURACIÓN DEL NÚCLEO INFANTIL: conserva viejo, costal y Mano Peluda; retira redención, peregrinación y poderes añadidos sin respaldo.",
    seoTitle: "El Viejo del Costal y la Mano Peluda",
    seoDescription:
      "Historia del anciano limosnero con costal y Mano Peluda usado en Caldas para asustar a los niños que lloraban, salían solos o desobedecían.",
    focusKeywords: [
      "Viejo del Costal",
      "Mano Peluda Caldas",
      "mitos infantiles de Colombia",
      "leyendas de Riosucio",
      "Hombre del Saco colombiano",
    ],
  }),
  defineCaldasMestizoMyth({
...
Y la escena del pretendiente rechazado por un padre intransigente, en medio de una guerra civil entre los propios vencedores, repite a escala de aldea lo que la historia de la gobernación cuenta en grande: la lucha entre Robledo y Benalcázar partió a los españoles de Anserma y Arma en dos bandos, y la derrota de uno arrastró a los que se habían pasado a él a última hora.`,
    ...
    sceneVertical:
      "Jerónimo regresa solo y entrega su sombrero ante Don Diego e Isabel, en una escena de rechazo contenida y sin armas",
    researchNotes:
      "FICCIÓN HISTÓRICA FIRMADA: conserva el dilema de Jerónimo y el marco de 1546, distingue hechos históricos de intimidad literaria y no celebra la obediencia colonial como valor universal.",
    seoTitle: "In illo tempore, leyenda de Otero D’Costa",
    seoDescription:
      "Ficción histórica de Enrique Otero D’Costa sobre Jerónimo de Vezga, su cambio de bando, la muerte de Robledo y el rechazo de Don Diego.",
    focusKeywords: [
      "In illo tempore Otero D’Costa",
      "Jerónimo de Vezga",
      "Jorge Robledo 1546",
      "leyendas de Anserma",
      "ficción histórica de Caldas",
    ],
  }),
  defineCaldasMestizoMyth({
    slug: "las-brujas",
...
Las fórmulas de Clementina, con uñas, colmillos, sangres y flores, tienen su espejo en el manual de brujería de Escobar Uribe que el propio narrador cita. Es la prueba de que la magia de la ladera salamineña circulaba por Antioquia y Caldas con las mismas palabras.`,
    ...
    sceneVertical:
      "Clementina abre un baúl con fotografías, velas, ramas y frascos de aguas perfumadas, en interior sobrio sin efectos mágicos literales",
    researchNotes:
      "DESFUSIÓN LITERARIA: centra la URL en Clementina y el relato firmado de Rodrigo Jiménez Mejía; separa a Aspasia, personaje de La bruja de las minas, y evita compilar brujas genéricas.",
    seoTitle: "Clementina, la bruja salamineña",
    seoDescription:
      "Relato de Rodrigo Jiménez Mejía sobre la visita a Clementina, sus fotografías, velas y objetos en el camino entre Salamina y Pácora.",
    focusKeywords: [
      "Clementina bruja salamineña",
      "brujas de Salamina",
      "Rodrigo Jiménez Mejía",
      "leyendas de Caldas",
      "camino Salamina Pácora",
    ],
  }),
];

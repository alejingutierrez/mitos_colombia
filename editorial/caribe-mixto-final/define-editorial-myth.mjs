import { buildCaribeMixtoFinalMyth } from "./build-editorial-myth.mjs";
import { pickCaribeMixtoFinalSources } from "./sources.mjs";

export function defineCaribeMixtoFinalMyth(input) {
  ...
  const selectedSources = pickCaribeMixtoFinalSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildCaribeMixtoFinalMyth({
    ...input,

import { buildCesarMestizoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickCesarMestizoResidualSources } from "./sources.mjs";

export function defineCesarMestizoResidualMyth(input) {
  ...
  const selectedSources = pickCesarMestizoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildCesarMestizoResidualEditorialMyth({
    ...input,

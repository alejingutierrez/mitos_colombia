export const chamiCommunityPage = {
  ...
  longDescription:
    "La colección Emberá Chamí reúne veintiuna páginas y diferencia tres capas documentales. Catorce relatos proceden de un grupo Chamí asentado en Corozal, municipio de Río Frío, y fueron transcritos en 1945 por Gerardo Reichel-Dolmatoff. Otros expedientes conservan memorias de Risaralda y del occidente de Caldas: la Jepá de Jeguada, los mundos creados por Dachicore, la culebra de siete cabezas de La Montaña y los espíritus de las gotas de Lomaprieta. Finalmente, Jinu Potó, el origen de los animales y las transformaciones se presentan como ciclos con variantes, no como una única narración homogénea. La revisión retira fusiones con relatos Katío y Dóbida, conserva todas las URL publicadas, documenta los límites de las fuentes históricas y devuelve a cada página un foco narrativo reconocible.",
  imagePrompt:
...
export const chamiCommunitySeo = {
  ...
  meta_description:
    "Explora 21 mitos Emberá Chamí de Río Frío, Risaralda y Caldas con fuentes, variantes regionales y contexto editorial verificable.",
  meta_keywords:
  ...
  twitter_description:
    "Conoce 21 relatos Chamí con procedencia, versiones y fuentes publicables.",
  canonical_path: "/comunidades/chami",
  summary:
    "La revisión conserva las veintiuna URL Chamí y reconstruye cada página desde fuentes con funciones distintas. El corpus de Río Frío queda acreditado como una transcripción histórica localizada; los relatos de Risaralda y Caldas recuperan narradores, lugares y bibliografía cuando están disponibles. Las páginas sintéticas declaran su condición de ciclos editoriales y dejan de mezclar episodios de otros pueblos Emberá. La colección también corrige geografía, etiquetas, SEO y pares visuales, con una dirección full paper cut y paper quilling.",
  focus_topics: [

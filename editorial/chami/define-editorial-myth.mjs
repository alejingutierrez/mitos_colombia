import { buildChamiEditorialMyth } from "./build-editorial-myth.mjs";
import {
  defaultChamiSourceKeys,
  pickChamiSources,
} from "./sources.mjs";

export function defineChamiMyth({
  sourceKeys = defaultChamiSourceKeys,
  seoTitle,
  seoDescription,
  ogTitle,
  ogDescription,
  ...
  const selectedSources = pickChamiSources(...sourceKeys);
  return buildChamiEditorialMyth({
    ...input,
    seoTitle,
    seoDescription,
    focusKeywords,

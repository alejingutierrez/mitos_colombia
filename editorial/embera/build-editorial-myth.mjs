...
import { EMBERA_CATEGORY_PATH } from "./universe.mjs";
import { emberaMedia } from "./media.mjs";
...
export function buildEmberaEditorialMyth(input) {
  const media = emberaMedia[input.slug];
  if (!media) {
  ...
  return {
    slug: input.slug,
    title: input.title,
    category_path: EMBERA_CATEGORY_PATH,
    tags: input.tags,

...
export default defineEmberaMyth({
  ...
  seoTitle: "Los Burumia: relato Emberá del río Bojayá",
  seoDescription:
    "Lee Los Burumia, relato narrado por Odilia Dogiramá sobre cautiverio, fuga, memoria de conflicto y navegación por el río Bojayá.",
  focusKeywords: [
    "Los Burumia",
    "mito Emberá",
    "Odilia Dogiramá",
  ...
  imagePromptVertical:
    "Segunda escena vertical 9:16, distinta de la portada, como ilustración full paper cut y paper quilling de borde a borde, no fotografía ni objeto físico. La canoa de los dos jóvenes llega a una curva del Bojayá; ellos levantan un canalete para hacerse reconocer y varias personas Emberá salen con cautela del rastrojo junto al río. Capas ilustradas de hojas, agua oscura y neblina, tensión contenida sin ataque visible, personajes estilizados y culturalmente sobrios, sin fuego, espíritu gigante, oro, texto, logos, marco, maqueta ni CGI.",
  researchNotes: `FUENTE PRIMARIA: “Los Burumia”, narrado por Odilia Dogiramá y publicado en Zrõarã Nẽburã (1984), es el único núcleo narrativo usado para el Relato.

FRONTERA CULTURAL: la ubicación en Usagará/Bojayá y el contexto del Alto Baudó permiten situar la narración en un ámbito Emberá Dóbida. Como la taxonomía vigente no contiene Dóbida, se conserva Emberá genérico y se declara la limitación.

EDICIÓN: “cholos” en la transcripción de 1984 se vuelve “gente Emberá” en la adaptación; la palabra histórica se explica en Historia. Se reduce el detalle gráfico sin eliminar cautiverio, antropofagia, fuga y guerra como motores de la narración.

SEPARACIONES: se retiran Karaví, el incendio, el oro, las Antomia, el incesto y las transformaciones de Carautas. Carauta, Bibidí y Bibidigomia se mantienen como relaciones documentales o relatos distintos, no como episodios de esta trama.

TÍTULO Y URL: el H1 pasa de “Los Burumiás y Carautas” a “Los Burumia”. El slug se conserva por continuidad pública.

GEOGRAFÍA: 6.148333, -77.098889 aproxima la confluencia cartográfica del Usagará con el Bojayá; no pretende ubicar la casa o el alto descritos.

IMÁGENES: la pareja anterior fue rechazada porque representaba un incendio y una deidad gigantesca inexistentes en la fuente. Fue reemplazada por una portada horizontal de la fuga en canoa y una segunda escena vertical del reconocimiento junto al Bojayá, ambas como ilustraciones full paper cut de borde a borde.`,
});

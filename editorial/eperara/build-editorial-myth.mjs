...
import { eperaraMedia } from "./media.mjs";
import { eperaraCategoryBySlug } from "./universe.mjs";
...
export function buildEperaraEditorialMyth(input) {
  const media = eperaraMedia[input.slug];
  const categoryPath = eperaraCategoryBySlug[input.slug];

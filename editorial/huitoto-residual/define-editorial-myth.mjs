import { buildHuitotoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickHuitotoResidualSources } from "./sources.mjs";

export function defineHuitotoResidualMyth(input) {
  ...
  const selectedSources = pickHuitotoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildHuitotoResidualEditorialMyth({
    ...input,

import { buildKatioEditorialMyth } from "./build-editorial-myth.mjs";
import {
  defaultKatioSourceKeys,
  pickKatioSources,
} from "./sources.mjs";

export function defineKatioMyth({
  sourceKeys = defaultKatioSourceKeys,
  seoTitle,
  seoDescription,
  ogTitle,
  ogDescription,
  ...
  const selectedSources = pickKatioSources(...sourceKeys);
  return buildKatioEditorialMyth({
    ...input,
    seoTitle,
    seoDescription,
    focusKeywords,

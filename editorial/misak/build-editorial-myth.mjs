...
import { misakMedia } from "./media.mjs";
import { misakCategoryBySlug } from "./universe.mjs";
...
export function buildMisakEditorialMyth(input) {
  const media = misakMedia[input.slug];
  const categoryPath = misakCategoryBySlug[input.slug];

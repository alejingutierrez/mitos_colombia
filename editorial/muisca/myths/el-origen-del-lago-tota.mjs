...
export default defineMuiscaMyth({
  ...
  latitude: 5.5407,
  longitude: -72.9332,
  mito: `Antes del lago había una hondonada tan seca que el viento levantaba polvo del fondo y lo hacía girar contra las montañas. Nadie cruzaba aquel lugar al caer la tarde. Entre las grietas respiraba Busiraco, una serpiente negra y enorme que guardaba el fuego bajo sus escamas.
...
En el mundo, el paralelo más citado es védico: Indra vence a Vritra, la serpiente que retiene las aguas, y el golpe libera los ríos que hacen habitable el mundo. La resonancia es notable —serpiente, retención, golpe, agua—, pero Indra es un dios de una tradición religiosa lejana, con armas y funciones propias; Monetá y Siramena no son equivalentes suyos. Comparar reconoce la estructura y no autoriza a proponer un origen común.`,
  ...
  seoDescription:
    "Lee el origen del lago de Tota: Busiraco, Monetá y Siramena en un relato literario con historia, versiones, significado y fuentes.",
  ogTitle: "El origen del lago de Tota: agua bajo la montaña",
  ogDescription:
    "Una serpiente guarda el fuego en una cuenca seca hasta que dos mujeres se atreven a abrir el camino del agua.",
  focusKeywords: [
    "origen del lago de Tota",
    "mito del lago de Tota",
    "Busiraco",
    "Monetá y Siramena",
    "leyendas de Tota",
    "mitología muisca de Boyacá",
  ],
  imagePrompt:

...
const editorialMyth = {
  ...
  "image_url": "https://c5htob7za0dl3b5x.public.blob.vercel-storage.com/mitos/editorial/el-pozo-de-hunzahua-497bc2c5af01.jpg",
  "keySources": [
    {
      "title": "El pozo de Hunzahúa",
      ...
      "summary": "Documenta la ubicación, el intento de Jerónimo Donato de Rojas y la tradición del tesoro."
    },
    {
      ...
      "summary": "Conserva el origen del pozo dentro del relato de Hunzahúa y la vasija quebrada."
    },
    {
      ...
      "summary": "Reúne el ciclo de Hunzahúa y su permanencia en la memoria territorial de Tunja."
    }
  ],
  "sources": [
    {
      ...
      "summary": "Corrige la confusión entre la captura de Quemuenchatocha y la ejecución posterior de otro zaque."
    },
    {
      ...
      "summary": "Aporta contexto histórico sobre invasión, cacicazgos y límites de la crónica colonial."
    },
    {
      ...
      "summary": "Ayuda a distinguir el valor ritual y arqueológico de los objetos de la fantasía extractiva del tesoro."
    },
    {
      ...
      "summary": "Permite reconocer la circulación literaria moderna del pozo dentro del ciclo narrativo de Hunzahúa."
    },
    {
      ...
      "summary": "Ofrece un contraste comunitario contemporáneo entre territorio, patrimonio y objeto de explotación."
    }
  ],
  "researchNotes": "ESTADO: revisión integral y corrección histórica.\n\nNÚCLEO DOCUMENTADO: sitio en Tunja; vínculo con Hunzahúa; tradición del tesoro de Quemuenchatocha; intento fallido de Jerónimo Donato de Rojas; nombre y refrán popular.\n\nVARIANTES: origen por chicha; tesoro oculto durante la conquista; buscador llamado Donato; relatos de vigas o conductos de oro no incluidos.\n\nMEMORIA CONTEMPORÁNEA: SITUR Boyacá y la UPTC mantienen el lugar como patrimonio y espacio cultural.\n\nHIPÓTESIS ACADÉMICA: la leyenda transforma un fracaso extractivo en memoria urbana.\n\nLECTURA EDITORIAL: el muchacho, el fragmento con huellas y el diálogo son invención responsable.\n\nDUDA: no hay confirmación arqueológica del tesoro descrito por la tradición.\n\nGEOGRAFÍA: coordenadas corregidas al Pozo de Hunzahúa en el campus de la UPTC, Tunja.\n\nIMAGEN: intento de desagüe colonial junto al pozo, con herramientas y un joven que recoge cerámica; sin cofres abiertos, oro visible, maquinaria moderna ni caricatura de maldición."
},

...
export default defineMuiscaMyth({
  slug: "nencatacoa",
  title: "Nencatacoa",
  tags: ["Nencatacoa", "arte", "celebración", "trabajo", "chicha"],
  latitude: 4.6509,
  longitude: -74.0913,
  mito: `En la sabana, cuando había que levantar un bohío grande antes de las lluvias, el trabajo comenzaba lejos, en el bosque.
...
Villa Posse lee a Nencatacoa como "dios de los artistas y de los bailes" y, siguiendo a Lilia Montaña, propone la Fiesta de San Pascual Bailón en los pueblos del lago de Tota como aculturación de las fiestas a Nencatacoa: el santo franciscano, patrono campesino de las fiestas y de los bailes, recibe la misma prueba de la llama que el viento mueve como señal de que el santo acompaña el baile. La continuidad es hipótesis folclórica, no cadena documental: lo que sí es visible es la permanencia de una estructura —la fiesta, el baile, el fuego— que el cristianismo no borró sino recicló.`,
  versiones: `Simón describe dos figuras para un mismo dios: el oso cubierto con la manta, forma principal en la que bailaba y cantaba y arrastraba los maderos; y la zorra, aparición ocasional que da origen al nombre Fo. La zorra tiene además una explicación del cronista que es un chiste lingüístico: "para que correspondiese la zorra con la borrachera", jugando con el sentido castellano de zorra como borracho. Compilaciones modernas invierten el orden y presentan a la zorra como forma habitual y al oso como variante, o funden ambas en un "animal del bosque".
...
El eco más largo es el de San Pascual Bailón. Montaña y Villa Posse documentan en los pueblos del lago de Tota una fiesta campesina del santo donde la prueba del cirio movido por el viento reproduce la prueba de la hoguera: si el viento mueve la llama, el santo ha aceptado y baila con los devotos. La semejanza de estructura es fuerte, pero no hay una cadena documental que pruebe la sustitución: se trata de una aculturación hipotética, no de un hecho registrado.`,
  ...
  similitudes: `La comparación más cercana está en el propio panteón muisca. Chaquén, el dios de los términos y de las carreras, recibía los adornos de la borrachera y de las fiestas; en su ciclo, el límite se recorre corriendo y se celebra bailando. Ambos son los dioses festivos del altiplano, con vocaciones opuestas: Chaquén custodia la raya que ordena, Nencatacoa pone el ritmo que desordena el cansancio. Huitaca, en el mismo corpus, encarna la fiesta que se derrama contra el orden de Bochica: los tres comparten la pregunta por el lugar del gozo en la vida común. Fuera del corpus no hay en los registros colombianos un dios comparable: la unión de trabajo y celebración sobrevive como práctica, en las mingas y jornadas colectivas andinas donde el canto y la chicha acompañan el esfuerzo, y en fiestas patronales como la de San Pascual Bailón, que reciclaron al santo fiestero.

En Mesoamérica, Xochipilli era el dios de las flores, el canto, la danza y el éxtasis ritual, asociado a la embriaguez sagrada. Resuena con Nencatacoa en la idea de que lo divino habita la música y la alegría colectiva; pero Xochipilli es una figura solar y cortesana, ligada al calendario y a las artes refinadas, mientras el dios muisca es un oso con manta que se harta de chicha con los trabajadores: el mismo territorio del gozo, otro rango social de la fiesta.

En la mitología griega, Dioniso es el dios del vino, de la fiesta y del éxtasis: su presencia suspende por un tiempo el orden ordinario y convierte la bebida compartida en experiencia comunitaria. Es la resonancia más citada desde Villa Posse, y es real: ambos se vuelven visibles en la alegría colectiva. La diferencia es de escala e historia: Dioniso tiene misterios, teatro, genealogías y metamorfosis; Nencatacoa no tiene mitología propia más allá de sus apariciones, y su fiesta no contradice el trabajo: lo corona y lo prepara. El sátiro, mitad animal y mitad hombre, bailarín de las fiestas dionisíacas, es el eco formal del oso con manta: la divinidad que llega del monte a bailar entre humanos. En ambos mundos la fiesta suspende el orden; en el altiplano, esa suspensión es el aliento con el que el trabajo vuelve a empezar.`,
  excerpt:
  ...
  seoTitle: "Nencatacoa: dios muisca de la chicha, el baile y el trabajo",
  seoDescription:
    "El mito de Nencatacoa: el dios muisca que se aparece como oso con manta, baila con la gente, bebe chicha y ayuda a arrastrar los maderos de los bohíos.",
  ogTitle: "Nencatacoa: el oso que baila con las cuadrillas",
  ogDescription:
    "Cuando un madero no se movía, llegaba del bosque un oso con la cola de fuera: cantaba, se hartaba de chicha y la faena entera se volvía fiesta.",
  focusKeywords: [
    "Nencatacoa",
    "dios de las borracheras",
    "mito de Nencatacoa",
    "Nencatacoa y la chicha",
    "dios muisca de los tejedores",
    "San Pascual Bailón y Nencatacoa",
  ],
  imagePrompt:
...
VARIANTES: oso con manta / zorra (Fo); aparición viva / figura de oro (Villa Posse); explicación de su ayuda con los maderos (Simón: porque en esas ocasiones se bebe mucho); sin ofrendas frente a divulgaciones que las añaden; la hoguera y el viento como prueba de su presencia; aculturación hipotética en San Pascual Bailón.

LICENCIA EDITORIAL: la escena del madero atascado, el telar, la pintura de mantas, el diálogo oracular y el cierre en imagen son invención; se conservan los materiales documentados: chicha, maderos, manta, oso, zorra y hoguera con viento.

DUDA: identidad zoológica exacta del oso (presumiblemente oso de anteojos), alcance y origen del nombre Fo, y la cadena folclórica de San Pascual Bailón, que es hipótesis de aculturación y no hecho documentado.

GEOGRAFÍA: Sabana de Bogotá como punto editorial; la noticia de Simón no ata la figura a un solo lugar; el eco de San Pascual Bailón se ubica en los pueblos del lago de Tota.

REGISTRO LINGÜÍSTICO: español colombiano contemporáneo, tono de cuento sagrado sin arcaísmos ni moralización; se evita "borrachera" como juicio y se lee la chicha como práctica material del lazo comunitario.`,
});

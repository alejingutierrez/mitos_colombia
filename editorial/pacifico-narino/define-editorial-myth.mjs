import { buildPacificoNarinoEditorialMyth } from "./build-editorial-myth.mjs";
import { pickPacificoNarinoSources } from "./sources.mjs";

export function definePacificoNarinoMyth(input) {
  ...
  const selectedSources = pickPacificoNarinoSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildPacificoNarinoEditorialMyth({
    ...input,

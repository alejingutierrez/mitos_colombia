import { buildPacificoRestanteEditorialMyth } from "./build-editorial-myth.mjs";
import { pickPacificoRestanteSources } from "./sources.mjs";

export function definePacificoRestanteMyth(input) {
  ...
  const selectedSources = pickPacificoRestanteSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildPacificoRestanteEditorialMyth({
    ...input,

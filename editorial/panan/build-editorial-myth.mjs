...
import { pananMedia } from "./media.mjs";
import { pananCategoryBySlug } from "./universe.mjs";
...
export function buildPananEditorialMyth(input) {
  const media = pananMedia[input.slug];
  const categoryPath = pananCategoryBySlug[input.slug];

import { buildPiedecuestaLegendaryAccountsEditorialMyth } from "./build-editorial-myth.mjs";
import { pickPiedecuestaLegendaryAccountsSources } from "./sources.mjs";

export function definePiedecuestaLegendaryAccountsMyth(input) {
  ...
  const selectedSources = pickPiedecuestaLegendaryAccountsSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildPiedecuestaLegendaryAccountsEditorialMyth({
    ...input,

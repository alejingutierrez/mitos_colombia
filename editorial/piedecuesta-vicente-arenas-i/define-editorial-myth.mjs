import { buildPiedecuestaVicenteArenasIEditorialMyth } from "./build-editorial-myth.mjs";
import { pickPiedecuestaVicenteArenasISources } from "./sources.mjs";

export function definePiedecuestaVicenteArenasIMyth(input) {
  ...
  const selectedSources = pickPiedecuestaVicenteArenasISources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildPiedecuestaVicenteArenasIEditorialMyth({
    ...input,

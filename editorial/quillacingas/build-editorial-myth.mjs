...
import { quillacingaMedia } from "./media.mjs";
import { quillacingaCategoryBySlug } from "./universe.mjs";
...
export function buildQuillacingaEditorialMyth(input) {
  const media = quillacingaMedia[input.slug];
  const categoryPath = quillacingaCategoryBySlug[input.slug];

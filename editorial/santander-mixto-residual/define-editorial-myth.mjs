import { buildSantanderMixtoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickSantanderMixtoResidualSources } from "./sources.mjs";

export function defineSantanderMixtoResidualMyth(input) {
  ...
  const selectedSources = pickSantanderMixtoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {

import { buildTicunaResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickTicunaResidualSources } from "./sources.mjs";

export function defineTicunaResidualMyth(input) {
  ...
  const selectedSources = pickTicunaResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildTicunaResidualEditorialMyth({
    ...input,

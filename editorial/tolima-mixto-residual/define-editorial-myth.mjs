import { buildTolimaMixtoResidualEditorialMyth } from "./build-editorial-myth.mjs";
import { pickTolimaMixtoResidualSources } from "./sources.mjs";

export function defineTolimaMixtoResidualMyth(input) {
  ...
  const selectedSources = pickTolimaMixtoResidualSources(input.sourceKeys || input.slug);
  if (input.sourceKeys) {
  ...
  return buildTolimaMixtoResidualEditorialMyth({
    ...input,

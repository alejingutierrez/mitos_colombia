const visualRule =
  "IMÁGENES: ilustración editorial 2D full paper cut y paper quilling, de acabado gráfico plano; nunca fotografía, objeto físico, maqueta, diorama, CGI ni render 3D.";

const communityStorySources = [
...
Un tercer punto de contacto es la idea de sostén. Los menhires repartidos por el territorio son, en el habla de los mitos cantados, kerkacha: postes de casa que unen las dos mitades del azul. Cada clan es a la vez una casa y uno de los ocho postes que sostienen el universo, y cuando una deidad purifica el territorio de un clan se sienta sobre esos postes. La caracterización del Ministerio de Cultura recoge la misma cifra al decir que el creador organizó el mundo sobre ocho bases. Roberto Lleras situó estas estructuras duales en el conjunto de los Andes Orientales, donde el par de opuestos es frecuente; lo infrecuente es que el tercer término, la mezcla, tenga tanto peso como los otros dos.`,
    ...
    seoDescription:
      "Conoce la cosmogonía U’wa de Rurcocá, Sira, Canwará y Rukwa, la mezcla de los mundos y el origen de los clanes en lagunas.",
    focusKeywords: [
      "mito de creación U’wa",
      "Rurcocá y Sira",
      "Rukwa",
      "mundos de colores U’wa",
      "cosmogonía U’wa",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de parejas U’wa emergiendo de lagunas en diferentes pisos del territorio, unidas por caminos de cuatro colores y el calor de Rukwa; composición simbólica respetuosa, sin tocados genéricos, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `REESCRITURA: se conserva la URL y se retiran prosa inventada y comparaciones Yin-Yang/nórdica.
RESTITUCIÓN: Rurcocá, Sira, Canwará y el origen de parejas en lagunas.
CAUTELA: Osborn documenta principalmente al clan Kubaruwa; no se universalizan grafías ni equivalencias.
UNIFICACIÓN: la siembra de parejas por Ruruna se integra al mismo ciclo cosmogónico.
${visualRule}`,
  },
  {
...
Un tercer punto de contacto es el de las plumas. Las del cientaro sirven, según el glosario del libro, para elaborar elementos sagrados. Osborn documenta que las plumas de pavo se insertaban en las capas ceremoniales y en los gorros de iniciación de las adolescentes, y que circulaban como artículo de intercambio entre habitantes de distintas zonas. Aconsejar al que camina y vestir la ceremonia resultan ser dos usos del mismo vínculo con esas aves.`,
    ...
    seoDescription:
      "Lee la historia U’wa de las aves y el tigrillo que protegen a los viajeros con cantos, advertencias y sueños.",
    focusKeywords: [
      "mensajes de los animales U’wa",
      "cientaro",
      "sueños U’wa",
      "animales consejeros",
      "historias U’wa",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena nocturna donde el tigrillo se aproxima simbólicamente al sueño de una familia y el canto del cientaro forma ondas de papel entre bosque y casa, sin fantasía genérica, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: Historias ancestrales U’wa, publicación bilingüe comunitaria de 2020.
NOMBRES: se conserva “cientaro” sin imponer identificación zoológica.
CAUTELA: no se infantiliza la relación entre animales, sueños y conducta.
GEOGRAFÍA: cerros Lobara, Serobakara y Toiroa; camino Cascajal-Mulera.
${visualRule}`,
  },
  {
...
Roberto Lleras describió para los Andes Orientales el funcionamiento general de las estructuras de pensamiento dual, donde los pares de opuestos son la regla. Lo que la comparación deja ver aquí es que la oposición no se resuelve eliminando un término: el oso muere, el hombre queda con el error encima y el bosque queda marcado por las dos lloradas.`,
    ...
    seoDescription:
      "Conoce el relato U’wa de un oso protector, una trampa nacida del miedo y un reconocimiento que llega demasiado tarde.",
    focusKeywords: [
      "el oso y el hombre U’wa",
      "oso de Bakokuira",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena simbólica de lágrimas del oso y del hombre convertidas en lluvia sobre el bosque de Bakokuira, con la trampa rota apenas sugerida, sin heridas explícitas, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Bako Kuira, Historias ancestrales U’wa.
CAUTELA: no se identifica especie ni se inventa un rescate.
NÚCLEO: protector confundido, trampa, reconocimiento tardío y armonización.
IMAGEN: violencia solo simbólica; no mostrar animal herido.
${visualRule}`,
  },
  {
...
El relato de Bako Kuira repite ese patrón con un cambio decisivo: la prueba no la pasa el más fuerte sino el que sabe relacionarse con esos cerros, y los perdedores no se van a otro lago por su cuenta sino que reciben una condición para seguir viviendo. Osborn añade un dato que explica por qué la prueba es posible: Kanwara da el alucinógeno a los pájaros para que puedan volar, y los pájaros se designan como aya, ordenamiento.`,
    ...
    seoDescription:
      "Lee la historia U’wa de Bistoa, el yopo y los tigres que deben cruzar cuatro dimensiones y aprender a respetar límites.",
    focusKeywords: [
      "competencia de los tigres U’wa",
      "Bistoa",
      "cerro Tina",
      "tigres U’wa",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de cuatro cerros superpuestos y un gran felino americano moteado del territorio ancestral en la altura mientras otros felinos moteados de los Llanos aceptan el límite junto a Bistoa, nunca tigres asiáticos rayados, sin caracola, humillación ni combate, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Bako Kuira, Historias ancestrales U’wa.
NOMBRE: “tigre” se conserva como traducción de la fuente; no se fuerza taxonomía.
NÚCLEO: cuatro dimensiones, prueba, límite territorial y compromiso.
CAUTELA: el yopo aparece en contexto ritual, no como efecto fantástico.
${visualRule}`,
  },
  {
...
El tercero es la regla del alimento, que este corpus repite en tres lugares distintos. Los viajeros no pueden consumir comida sin purificar ni aceptar la de los hermanos menores; Uktara no puede probar nada de lo que le ofrecen las almas si quiere regresar; y la reseña que William Torres hizo de la autobiografía de Berichá cuenta que ella nació sin piernas porque su madre transgredió la norma de comer pescado del río Cobaría sin purificarlo antes. Comer algo ajeno es, en los tres casos, quedarse del lado de donde vino la comida.`,
    ...
    seoDescription:
      "Conoce la historia U’wa de Monoa, protector de viajeros y familias cuya memoria permanece en una quebrada.",
    focusKeywords: [
      "Monoa U’wa",
      "hijo de la montaña",
      "Monoa Lia",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena simbólica del niño Monoa junto a una quebrada que recibe su nombre, con una corriente roja transformada gradualmente en agua azul y un sendero que se cierra, sin animales, herida, cadáver ni texto, sin objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Anteta, Historias ancestrales U’wa.
NOMBRES: Urkoa, Kakasoa, Shinkuata y Konara se conservan sin inventar apariencia.
CAUTELA: muerte infantil narrada e ilustrada solo de forma simbólica.
GEOGRAFÍA: la quebrada Monoa Lia no se geolocaliza públicamente.
${visualRule}`,
  },
  {
...
Un tercer punto de contacto cruza hacia la vida cotidiana. Los U’wa no hacen una distinción tajante entre ellos y los animales, porque unos y otros están conformados por las mismas propiedades originales y ambos obtienen sustancias alucinógenas en los mitos; las diferencias vienen de las mezclas específicas que a cada grupo le tocaron. Que un ave posea un saber que las personas todavía no tienen no es, en ese marco, una inversión del orden, sino un reparto que aún no había terminado.`,
    ...
    seoDescription:
      "Lee el relato U’wa de Kejeta, el pájaro carpintero que cura con tabaco y soplo y entrega un mandato de sanación.",
    focusKeywords: [
      "pájaro carpintero U’wa",
      "Kejeta",
      "curación U’wa",
      "soplo y tabaco",
      "historias ancestrales U’wa",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena del poder de curar pasando como ondas de papel desde Kejeta hacia manos humanas que cuidan plantas, ave y territorio, sin halo religioso, magia brillante, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Ihurima, “Kejeta”, Historias ancestrales U’wa.
CAUTELA: no se inventan secretas, fórmulas ni procedimiento médico.
NÚCLEO: curación, transferencia del poder y mandato hacia todos los seres.
IMAGEN: soplo simbólico, sin herida visible.
${visualRule}`,
  },
  {
...
El tercero es el destino del cuerpo. Osborn recogió que un oso que mató a una criatura fue enterrado como gente, porque en el mundo de abajo iba a volverse un ser humano. Aquí ocurre lo contrario y por eso no hay entierro: a Kubashoa lo dejan en la cueva de la peña Toiroa, uno de los cuatro pilares de la dimensión de la Tierra, y a los cuatro días el cuerpo ya no está.`,
    ...
    seoDescription:
      "Conoce a Kubashoa, protector U’wa nacido del tabaco que viaja entre formas y trasciende hacia la dimensión de Sira.",
    focusKeywords: [
      "Kubashoa U’wa",
      "hijo del tabaco",
      "Sira",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de la cueva de Toiroa vacía bajo lluvia, con una perdiz cantando y la presencia felina de Kubashoa sugerida entre nubes de papel hacia la dimensión de Sira, sin cadáver, halo, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Minsaka, Historias ancestrales U’wa.
DISTINCIÓN: Kubashoa no se fusiona con Kusbasha, protagonista del relato de Lisha.
CAUTELA: no se identifican los Tiga con un pueblo histórico ni se muestra violencia.
GEOGRAFÍA: Taurete y Toiroa se conservan sin geolocalización exacta.
${visualRule}`,
  },
  {
...
Un tercer punto de contacto es el precio del viaje. Kusbasha vuelve pálido y desnudo porque Lisha se bebió su sangre, y necesita chicha, guayuco, ruana y hamaca para reponerse. Es el mismo balance de pérdida y reposición que Osborn describe para las ceremonias de soplar, donde quien oficia queda expuesto y debe ser purificado después.`,
    ...
    seoDescription:
      "Lee el relato U’wa de Lisha y Kusbasha, donde la sangre de la madre del agua se convierte en ríos del territorio.",
    focusKeywords: [
      "Lisha madre del agua",
      "Kusbasha U’wa",
      "río Keroa",
      "mito U’wa del agua",
      "historias ancestrales U’wa",
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de una gota que nace de una vena vegetal simbólica y crece en cuatro corrientes azules por el territorio U’wa; Kusbasha descansa junto a una casa mientras Lisha permanece como agua, sin animales, caracola, tambor, instrumentos, anatomía, texto, objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Tabut Ak Lia, Historias ancestrales U’wa.
DISTINCIÓN: Kusbasha no se confunde con Kubashoa.
CAUTELA: contenido corporal preservado en texto sin representación gráfica.
GEOGRAFÍA: río Keroa y laguna entre peñas, sin geolocalización exacta.
${visualRule}`,
  },
  {
...
Entre los dos queda claro por qué el relato no celebra a Sirbetuna. Él amarra la vaca al primer intento, la cocina y se la come solo, y esa comida sin reparto es lo que Dasa Duba observa antes de decidir. Lo que se retira del territorio no es la abundancia: es la posibilidad de comer sin compartir.`,
    ...
    seoDescription:
      "Conoce la historia U’wa de Yanoa, Sirbetuna y el ganado, una reflexión ancestral sobre poder, acumulación e identidad.",
    focusKeywords: [
      "Yanoa y Sirbetuna",
      "Dasa Duba",
      "ganado U’wa",
      "riqueza y territorio U’wa",
      "historias ancestrales U’wa",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de Yanoa transformándose con dignidad en ave y volando hacia los Llanos, mientras una espada, una lanza y una olla quedan guardadas lejos del territorio U’wa, sin otros animales, caracola, tambor, textiles enrollados, derrota humillante ni texto, sin objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Minsaka, Historias ancestrales U’wa.
CONTACTO: ganado y objetos se conservan como parte de una tradición histórica viva.
CAUTELA: no se identifican especie del ave ni forma de los objetos de poder.
NÚCLEO: propiedad, acumulación, identidad y equilibrio territorial.
${visualRule}`,
  },
  {
...
Eso explica el regalo del regreso. Uktara no vuelve con un mensaje ni con un objeto: vuelve con semillas de batata roja y de kabesha, es decir, trae de allá justamente la materia con la que allá se nombra a los animales de aquí.`,
    ...
    seoDescription:
      "Lee la historia U’wa de Uktara, quien conoce la dimensión de los muertos y vuelve con semillas y saber.",
    focusKeywords: [
      "recorrido de Uktara",
      "dimensión de los muertos U’wa",
      "Uktar Bijega",
      "batata roja y kabesha",
      "historias U’wa",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena serena de Uktara regresando por la entrada rocosa con semillas de batata roja y kabesha, mientras murciélagos y sombras humanas abstractas quedan en la otra dimensión; sin calaveras, huesos, rostros fantasmales, terror, portal de fantasía genérico ni texto, sin objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `FUENTE DIRECTA: sede Onkasa, “Uktar Bijega”, Historias ancestrales U’wa.
CAUTELA: no se geolocalizan entradas ni se detallan prácticas con yopo.
ALIMENTOS: kabesha se conserva como nombre de planta silvestre; sin identificación científica.
NÚCLEO: visita, prohibición de comer, semillas, retorno y transmisión.
${visualRule}`,
  },
  {
...
Un tercer contraste ordena los dos anteriores. La miel y el yopo se consumen por las mismas razones y buscando efectos parecidos, pero de maneras opuestas: la miel se toma y recorre el tracto digestivo nutriendo y limpiando, como la leche del maíz tierno; el yopo se inhala, sube por la columna vertebral y llega a los genitales, y se cree que produce el material de los huesos y del alma.`,
    ...
    seoDescription:
      "Conoce el ordenamiento U’wa de las abejas, hijas del Sol que llevan miel, cera y continuidad al mundo intermedio.",
    focusKeywords: [
      "abejas hijas del Sol U’wa",
      "ordenamiento de las abejas",
      "Anbaiya",
      "Rukwa y Kanwara",
      "mitología U’wa",
    ],
    ...
    imagePromptVertical:
      "Ilustración vertical 2D full paper cut y paper quilling, acabado gráfico plano sin fotografía: segunda escena de pequeñas abejas nativas sin aguijón, oscuras y sin franjas amarillas y negras, bañándose simbólicamente en el lago amarillo Rayria y volando con Yagshowa hacia casas, árboles y clanes del mundo intermedio; una pareja queda arriba como reserva, sin otros animales, personas, instrumentos, alas de hada, personajes coronados ni texto, sin objeto físico, maqueta, diorama, CGI ni render 3D.",
    researchNotes: `ADICIÓN: núcleo ausente y ampliamente documentado en Osborn, Falchetti y fuentes institucionales.
CAUTELA: no se reconstruye el canto completo ni se presenta una ceremonia Kubaruwa como universal.
UNIFICACIÓN EDITORIAL: Reowa, Aya, soplada del alucinógeno y zorro/zarigüeya quedan como contexto, no páginas fragmentarias.
IMAGEN: abejas sin aguijón y cuatro mundos; sin colmena apícola moderna.
${visualRule}`,
  },
];

export default uwaDefinitions;

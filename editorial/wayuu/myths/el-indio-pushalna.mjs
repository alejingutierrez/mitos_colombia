...
export default defineWayuuMyth({
  ...
  similitudes,
  excerpt:
    "Tras caer del caballo Kasap, Pushaina vuelve acompañado por una voz que le da conocimiento y adopta formas de gallinazo y ciempiés.",
  seoTitle: "El indio Pushaina: retorno y transformación",
  seoDescription:
    "Lee el relato Wayuu de Pushaina: su caída del caballo Kasap, el retorno de la muerte, una presencia invisible, adivinación y metamorfosis.",
  focusKeywords: [
    "El indio Pushaina",
    "Pushaina Wayuu",
    "mito de Pushaina",
    "Kasap",
    "transformación Wayuu",
    "espíritus Wayuu",
  ],
...
NÚCLEO: caída de Kasap, retorno, voz invisible que pide alimento, anillo localizado y formas de gallinazo/ciempiés.

CAUTELA: no diagnosticar la caída ni llamar piache a Pushaina sin evidencia.

IMAGEN: se conserva la imagen publicada; no hubo regeneración.

GEOGRAFÍA: punto aproximado en territorio Wayuu; la fuente no fija el lugar de la caída.`,
});

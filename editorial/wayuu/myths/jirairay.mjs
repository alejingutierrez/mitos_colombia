...
export default defineWayuuMyth({
  ...
  similitudes,
  excerpt:
    "Jirairay no es un espíritu independiente: es el canto o nombre con que una piache invoca a Wanurü durante una ceremonia de curación.",
  seoTitle: "Jirairay: canto Wayuu para llamar a Wanurü",
  seoDescription:
    "Conoce la corrección documental de Jirairay: no un dios autónomo, sino un canto o nombre de invocación de Wanurü en prácticas de piaches.",
  focusKeywords: [
    "Jirairay",
    "Jirairay Wayuu",
    "Wanurü",
  ...
  tags: ["Jirairay", "Wayúu", "curación", "espiritualidad", "muerte"],
  sourceKeys: [
    "pineda1950",
    "chaves1946",
    "villa1993",
...
ESTADO: reconstrucción editorial de ceremonia; no mito narrativo autónomo.

DECISIÓN: URL preservada y enlazada con Umaralá para corregir públicamente el error en vez de ocultarlo.

IMAGEN: se conserva la imagen existente sin afirmar que represente un ser con forma documentada.

GEOGRAFÍA: punto aproximado en territorio Wayuu; un canto ritual no corresponde a un único lugar.`,
});

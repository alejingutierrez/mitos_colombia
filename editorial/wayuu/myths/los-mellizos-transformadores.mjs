...
const imagePromptHorizontal = `Portada horizontal 16:9 de “Los mellizos transformadores” como ilustración editorial digital 2D full paper cut y paper quilling, acabado gráfico plano de borde a borde, nunca fotografía, objeto físico, maqueta, diorama, CGI ni render 3D. En la Alta Guajira nocturna aparecen exactamente dos niños mellizos de baja estatura, Tumaju’le y Peeliyuu, como siluetas infantiles masculinas abstractas de recortes lisos, cabello corto y prendas monocromas color arena sin patrones; uno empieza a transformarse en una nube baja de recortes blancos y grises. Caminan entre cardones y planos de la Macuira con mar lejano; no incluir casas, rancherías, poblados, edificios ni arquitectura. Presencias felinas oscuras quedan como siluetas pequeñas, remotas y ambiguas. Bordes de papel visibles, filigrana selectiva y sombras suaves entre planos; índigo, ocre, arena y verde cardón. No representar mujeres ni adultos; sin bolsos, mochilas, joyas, mantas decoradas, motivos textiles o vestuario ceremonial; sin violencia explícita, tocados panindígenas, texto, logos, marco ni fotorrealismo.`;

const imagePromptVertical = `Segunda escena vertical 9:16 de “Los mellizos transformadores”, distinta de la portada, como ilustración editorial digital 2D full paper cut y paper quilling, acabado gráfico plano de borde a borde, nunca fotografía, objeto físico, maqueta, diorama, CGI ni render 3D. En un desfiladero de la Alta Guajira aparecen exactamente dos niños mellizos de baja estatura, Tumaju’le y Peeliyuu, como siluetas infantiles masculinas abstractas de recortes lisos, cabello corto y prendas monocromas color arena sin patrones; observan a la paloma Aáner posada sobre un cardón. Unas huellas de ave y tres plumas sencillas en la arena sugieren la revelación de su origen: no usar letras, glifos, espirales, triángulos ni símbolos geométricos. Composición ascendente hacia la luna y una nube fina como presagio, capas gráficas recortadas y filigrana selectiva en índigo, arena, piedra y verde cardón. No representar mujeres ni adultos; sin bolsos, mochilas, joyas, mantas decoradas, motivos textiles o vestuario ceremonial; sin casas, violencia, máscaras, tocados panindígenas, texto, logos, marco ni fotorrealismo.`;

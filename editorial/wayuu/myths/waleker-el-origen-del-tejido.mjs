...
export default defineWayuuMyth({
  ...
  similitudes,
  excerpt:
    "Waleker teje de noche con hilos de colores, pierde su forma humana cuando Irunúu rompe una promesa y deja su saber a las mujeres Wayuu.",
  seoTitle: "Waleker: origen del tejido Wayuu",
  seoDescription:
    "Lee la leyenda Wayuu de Waleker, Irunúu y el origen del tejido, con sus variantes y el contexto vivo de la transmisión entre mujeres.",
  focusKeywords: [
    "Waleker",
    "Wale’kerü",
    "origen del tejido Wayuu",
    "Irunúu",
    "leyenda de la araña Wayuu",
    "tejedoras Wayuu",
  ],
...
NÚCLEO PRINCIPAL: Irunúu/Wokoloonat, tejido nocturno, secreto, revelación ante espíritus, transformación en araña y legado textil.

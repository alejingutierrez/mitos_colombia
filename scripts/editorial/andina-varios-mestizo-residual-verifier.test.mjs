...
test("el verificador reporta contenido listo e imágenes pendientes", () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/verify-andina-varios-mestizo-residual-review.mjs"],
...
test("el modo estricto impide afirmar cierre sin imágenes", () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/verify-andina-varios-mestizo-residual-review.mjs", "--strict"],
    { cwd: process.cwd(), encoding: "utf8" },
  );

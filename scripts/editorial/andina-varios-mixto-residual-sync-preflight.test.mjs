...
test("la sincronización prepara tres actualizaciones sin altas ni bajas", { skip: skipWithoutPostgres }, () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/sync-andina-varios-mixto-residual-review.mjs"],

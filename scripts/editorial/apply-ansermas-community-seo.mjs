...
import {
  ...
  ansermasCommunitySeoPayload,
} from "../../editorial/ansermas/community.mjs";
...
async function run() {
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: ansermasCommunitySeo.meta_title,
          canonical: ansermasCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const seo = ansermasCommunitySeo;
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(ansermasCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

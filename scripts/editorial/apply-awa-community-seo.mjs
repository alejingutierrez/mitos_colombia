...
import {
  awaCommunitySeo,
  awaCommunitySeoPayload,
} from "../../editorial/awa/community.mjs";
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: awaCommunitySeo.meta_title,
          canonical: awaCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(awaCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

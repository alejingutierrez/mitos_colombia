...
import {
  bariCommunitySeo,
  bariCommunitySeoPayload,
} from "../../editorial/bari/community.mjs";
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: bariCommunitySeo.meta_title,
          canonical: bariCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(bariCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

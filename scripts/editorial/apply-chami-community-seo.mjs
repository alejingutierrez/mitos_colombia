  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: chamiCommunitySeo.meta_title,
          canonical: chamiCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(chamiCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

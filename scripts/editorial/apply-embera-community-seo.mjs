  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: emberaCommunitySeo.meta_title,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        PAGE_TYPE,
        SLUG,
        emberaCommunitySeo.meta_title,
        emberaCommunitySeo.meta_description,
        emberaCommunitySeo.meta_keywords,
        emberaCommunitySeo.og_title,
        emberaCommunitySeo.og_description,
        emberaCommunitySeo.twitter_title,
        emberaCommunitySeo.twitter_description,
        emberaCommunitySeo.canonical_path,
        emberaCommunitySeo.summary,
        JSON.stringify(emberaCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

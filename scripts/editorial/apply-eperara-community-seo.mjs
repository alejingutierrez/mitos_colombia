...
import {
  eperaraCommunitySeo,
  eperaraCommunitySeoPayload,
} from "../../editorial/eperara/community.mjs";

const { Client } = pg;
const PAGE_TYPE = "community";
const SLUG = "eperara-siapidara";
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: eperaraCommunitySeo.meta_title,
          canonical: eperaraCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(eperaraCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: katioCommunitySeo.meta_title,
          canonical: katioCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(katioCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

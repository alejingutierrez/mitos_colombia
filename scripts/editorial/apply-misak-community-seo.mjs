...
import {
  misakCommunitySeo,
  misakCommunitySeoPayload,
} from "../../editorial/misak/community.mjs";
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: misakCommunitySeo.meta_title,
          canonical: misakCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(misakCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

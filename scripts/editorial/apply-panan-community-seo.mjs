...
import {
  pananCommunitySeo,
  pananCommunitySeoPayload,
} from "../../editorial/panan/community.mjs";
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: pananCommunitySeo.meta_title,
          canonical: pananCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(pananCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

...
import {
  ...
  quillacingaCommunitySeoPayload,
} from "../../editorial/quillacingas/community.mjs";

const { Client } = pg;
const PAGE_TYPE = "community";
const SLUG = "quillacingas";
...
async function run() {
  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: quillacingaCommunitySeo.meta_title,
          canonical: quillacingaCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const seo = quillacingaCommunitySeo;
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(quillacingaCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

  ...
  try {
      ...
      JSON.stringify(
        {
          ...
          nextTitle: wounaanCommunitySeo.meta_title,
          canonical: wounaanCommunitySeo.canonical_path,
        },
        null,
        2,
      ),
    ...
    const result = await client.query(
      ...
      [
        ...
        seo.canonical_path,
        seo.summary,
        JSON.stringify(wounaanCommunitySeoPayload()),
      ],
    );
    console.log(
      JSON.stringify(

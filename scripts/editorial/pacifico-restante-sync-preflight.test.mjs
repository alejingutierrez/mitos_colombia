...
test("la sincronización prepara ocho actualizaciones sin despublicar", { skip: skipWithoutPostgres }, () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/sync-pacifico-restante-review.mjs"],
  ...
  assert.deepEqual(output.universe.preservedAdditional, ["el-padre-mera"]);

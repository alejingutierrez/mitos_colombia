...
test("la sincronización prepara cuatro correcciones sin altas ni bajas", { skip: skipWithoutPostgres }, () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/sync-piedecuesta-relatos-legendarios-review.mjs"],

...
test("el verificador reporta la incorporación y las imágenes pendientes", () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/verify-piedecuesta-second-cycle-review.mjs"],
  ...
  assert.deepEqual(output.missing, ["la-bruja-silbona"]);

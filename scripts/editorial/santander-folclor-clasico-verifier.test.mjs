...
test("el verificador reporta las seis rutas e imágenes pendientes", { skip: skipWithoutPostgres }, () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/verify-santander-folclor-clasico-review.mjs"],

...
test("la sincronización prepara dos actualizaciones sin altas ni bajas", { skip: skipWithoutPostgres }, () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/sync-santander-mixto-residual-review.mjs"],

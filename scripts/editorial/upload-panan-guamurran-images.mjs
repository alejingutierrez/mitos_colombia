...
import guamurran from "../../editorial/panan/myths/guamurran-madre-de-agua.mjs";

const confirmationPhrase = "upload-panan-guamurran-full-paper-cut-pair";
const definitions = [
  {
    orientation: "horizontal",
    path: "artifacts/generated-images/panan/guamurran-madre-de-agua-horizontal.jpg",
    width: 1536,
    height: 864,
  },
  {
    orientation: "vertical",
    path: "artifacts/generated-images/panan/guamurran-madre-de-agua-vertical.jpg",
    width: 864,
    height: 1536,
  },
];
  ...
  for (const definition of definitions) {
    ...
    const prompt =
      definition.orientation === "horizontal"
        ? guamurran.image_prompt_horizontal
        : guamurran.image_prompt_vertical;
    if (
...
function blobPath(asset, runEpoch) {
  ...
  return `${folder}/guamurran-madre-de-agua-${runEpoch}.jpg`;
}
...
async function saveManifest(uploaded) {
  const manifestPath = path.resolve(
    "artifacts/generated-images/panan/guamurran-uploaded.json",
  );
  await fs.writeFile(
    manifestPath,
    `${JSON.stringify(
      {
        ...
        style:
          "full paper cut and paper quilling illustration; no photography, physical object, maquette, diorama, CGI or 3D render",
        assets: uploaded.map(

...
const confirmationPhrase = "upload-two-pirsa-full-paper-cut-images";
const outputDir = path.resolve("artifacts", "generated-images", "pirsa");
const manifestPath = path.join(outputDir, "manifest.json");
const items = [
  {
    key: "el-exorcismo-de-tamaracunga:horizontal",
  ...
  {
    key: "el-exorcismo-de-tamaracunga:vertical",
    slug: "el-exorcismo-de-tamaracunga",
...
async function run() {
  ...
  for (const item of items) {
    ...
    console.log(`[pirsa-upload] ok ${item.key}`);
  }
  await fs.writeFile(
    manifestPath,

...
const confirmationPhrase = "upload-six-quimbaya-full-paper-cut-images";
const outputDir = path.resolve("artifacts", "generated-images", "quimbaya");
...
async function run() {
  ...
  for (const item of items) {
    ...
    console.log(`[quimbaya-upload] ok ${item.key}`);
  }
  await fs.writeFile(
    manifestPath,

...
const confirmationPhrase = "upload-four-umbra-full-paper-cut-images";
const outputDir = path.resolve("artifacts", "generated-images", "umbra");
...
async function run() {
  ...
  for (const item of items) {
    ...
    console.log(`[umbra-upload] ok ${item.key}`);
  }
  await fs.writeFile(
    manifestPath,

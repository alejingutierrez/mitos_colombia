...
test("el generador Yagua prepara catorce imágenes OpenAI de alta calidad", () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/generate-yagua-images.mjs"],
    {
      cwd: process.cwd(),
      encoding: "utf8",
    },
  ...
  assert.equal(output.community, "Frente Yagua / Ñihamwo");

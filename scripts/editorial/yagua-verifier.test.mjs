...
test("el verificador Yagua declara seis rutas y una transferencia pendientes", { skip: skipWithoutPostgres }, () => {
...
test("el modo estricto impide afirmar cierre Yagua antes de imágenes y sync", { skip: skipWithoutPostgres }, () => {
  const result = spawnSync(
    process.execPath,

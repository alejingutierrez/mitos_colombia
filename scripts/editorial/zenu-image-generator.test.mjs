...
test("el generador Zenú prepara catorce imágenes OpenAI de alta calidad", () => {
  const result = spawnSync(
    process.execPath,
    ["scripts/editorial/generate-zenu-images.mjs"],
    {
      cwd: process.cwd(),
      encoding: "utf8",
    },
  ...
  assert.equal(output.community, "Frente Zenú");

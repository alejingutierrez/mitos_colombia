...
export function buildPlannerSystemPrompt({
  ...
  const prompt = [
    ...
    "El carrusel debe tener entre 9 y 11 láminas. Usa 10 como norma cuando exista una tercera imagen: suficiente para narrar sin fragmentar la lectura.",
    requireThirdImage
    ...
    "Distribuye las imágenes como hitos, no como galería: portada en 1, segunda escena cerca de 4 y tercera escena cerca de 8. Debe haber al menos dos láminas completas entre imágenes.",
    "El mapa funciona como transición territorial. Puede preceder inmediatamente a la segunda imagen cuando la secuencia lugar → aparición mejora la continuidad; en cualquier otro caso no lo pegues a una imagen.",
    ...
    "No repitas el titular como primera oración del cuerpo. El titular abre; el cuerpo añade acción, causa, consecuencia o contexto.",
    "Ningún titular puede superar 64 caracteres; en láminas con imagen usa idealmente 60 o menos.",
    "Si generated_image.needed es true, completa art_direction con moment, subject, action, setting, framing, continuity y differentiation. Cada campo debe ser concreto, verificable contra el relato y útil para producir una imagen distinta de las dos referencias.",
    ...
    "El inicio debe detener el scroll sin clickbait. La última lámina debe dejar una idea o pregunta en máximo 32 palabras para reservar el tercio inferior a la invitación estándar de leer el relato completo en mitosdecolombia.com. No escribas esa invitación: el compositor la añade automáticamente y no crea una lámina adicional.",

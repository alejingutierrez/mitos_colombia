...
export const ITEMS = armar([
  ...
  escp("b1a", [ref("tejedora_alma"), ref("barranco_tenebroso")], {
    comun: `Luz difusa que no tiene fuente. ${TEJEDORA} al pie del MISMO barranco de la referencia, sentada en la tierra con la espalda contra la pared amarilla. No hay nadie más. Objeto ancla: sus párpados.`,
    camara: {
      a: "PLANO DETALLE de sus párpados cerrados, la cara llenando el cuadro contra la pared de tierra amarilla.",
      b: "la cámara ha RETROCEDIDO y ha subido hasta un PLANO GENERAL en contrapicado del barranco entero, con ella diminuta y sentada al pie de una pared que sube fuera de cuadro.",
    },
  ...
  escp("b1b", [ref("tejedora_alma")], {
    comun: `Luz difusa y baja sobre fondo oscuro. Las MISMAS manos anchas de la referencia, con los dedos marcados por el hilo. No hay hilo, ni telar, ni herramienta: sólo el gesto que se acuerda de ellos. Objeto ancla: el hueco vacío entre los dedos.`,
    camara: {
      a: "PLANO MEDIO de ella sentada, con las manos abiertas sobre las rodillas.",
      b: "la cámara ha AVANZADO hasta las manos y se ha puesto cenital: PLANO MACRO de los diez dedos, con su cara fuera de campo.",
    },
  ...
  escp("b2a", [ref("barranco_tenebroso"), ref("tejedora_alma")], {
    comun: `Luz difusa sin fuente y sin cielo visible arriba. EL MISMO barranco de la referencia con su sendero angosto pegado a la pared entre tierras amarillas y negras; ${TEJEDORA} pequeña dentro de la garganta, de espaldas. Objeto ancla: el sendero.`,
    camara: {
      a: "PLANO GENERAL en picado alto sobre la garganta, ella pequeña dentro de ella y de espaldas.",
      b: "la cámara ha BAJADO hasta el sendero y la sigue pegada a su espalda: PLANO MEDIO desde detrás, con la pared rozando el objetivo y el vacío al otro lado.",
    },
  ...
  escp("b2b", [ref("tejedora_alma"), ref("barranco_tenebroso")], {
    comun: `Cámara retrocediendo por el sendero. ${TEJEDORA} avanzando hacia la cámara, con el barranco cerrándose detrás de ella. No se oye nada y no la sigue nadie: el encuadre está hecho para que el silencio se note. Objeto ancla: el camino vacío a su espalda.`,
    camara: {
      a: "PLANO MEDIO frontal retrocediendo por el sendero delante de ella.",
      b: "la cámara se ha QUEDADO QUIETA y la ha dejado pasar: PLANO GENERAL desde el sitio donde estaba, con ella alejándose de espaldas por el fondo de la garganta.",
    },
  ...
  esc("b3a", [ref("rio_de_las_almas")], {
    comun: "Luz difusa y sin fuente. EL MISMO río de la referencia, corriente ancha y oscura de superficie lisa y sin espuma, con la otra orilla apenas adivinándose al fondo. No hay puente, no hay canoa, no hay embarcadero. Objeto ancla: la otra orilla.",
    camara: {
      a: "PLANO MEDIO desde la ribera de piedra, con una piedra negra grande en primer término y el agua detrás.",
      b: "la cámara ha VOLADO sobre el agua hacia el centro del río y ha girado: GRAN PLANO GENERAL a ras de la corriente, con las dos orillas igual de lejos.",
    },
  ...
  escp("b3b", [ref("tejedora_alma"), ref("rio_de_las_almas")], {
    comun: `Luz difusa. ${TEJEDORA} de pie en la ribera del MISMO río de la referencia, diminuta contra el ancho del agua. Objeto ancla: su silueta contra el agua.`,
    camara: {
      a: "GRAN PLANO GENERAL desde muy atrás, ella diminuta y de espaldas ante el ancho del agua.",
      b: "la cámara ha AVANZADO hasta su espalda y ha bajado a sus pies: PLANO DETALLE de sus pies descalzos en el filo del agua, con la corriente pasando.",
    },
  ...
  esc("b4a", [ref("rio_de_las_almas"), ref("balsa_arana")], {
    comun: "Luz rasante que hace brillar la plata. Una piedra de la ribera y, sobre ella, LA MISMA araña de papel de la referencia, mediana y tranquila, con un hilo fino saliéndole del cuerpo. No es una amenaza: está trabajando. Objeto ancla: el hilo que le sale del cuerpo.",
    camara: {
      a: "PLANO MACRO sobre la araña de papel posada en la piedra, que llena medio cuadro.",
      b: "la cámara ha RETROCEDIDO siguiendo el hilo que le sale del cuerpo: PLANO MEDIO en el que se ve la piedra entera y el abanico de hilos saliendo hacia el agua.",
    },
  ...
  esc("b4b", [ref("rio_de_las_almas")], {
    comun: "A ras del agua. Sobre EL MISMO río de la referencia, miles de hilos finísimos y plateados tendidos de orilla a orilla formando una trama tensa y ligera. Objeto ancla: la trama sobre el agua.",
    camara: {
      a: "PLANO MEDIO a ras del agua con dos hilos cruzando muy cerca del objetivo.",
      b: "la cámara se ha ELEVADO en vertical hasta un PICADO ALTO sobre el río: la trama entera se lee ahora como una tela tendida de orilla a orilla.",
    },
  ...
  esc("b5a", [ref("balsa_arana"), ref("rio_de_las_almas")], {
    comun: "Luz difusa con reflejos de plata. LA MISMA araña de la referencia sobre la piedra, de perfil, entera en cuadro y sin ninguna deformación monstruosa. Habla de su oficio, no amenaza. Objeto ancla: la araña.",
    camara: {
      a: "PLANO MEDIO CORTO de la araña de perfil sobre la piedra, entera en cuadro.",
      b: "la cámara ha RODEADO la piedra hasta ponerse detrás de ella y ha bajado: CONTRAPICADO desde el agua, con la araña recortada arriba y la trama abriéndose hacia el objetivo.",
    },
  ...
  escp("b5b", [ref("tejedora_alma"), ref("balsa_arana")], {
    comun: `Luz rasante. El pie descalzo de LA MISMA tejedora de la referencia sobre LA MISMA balsa de tela de araña de la referencia, plataforma ovalada tejida de hilos plateados tan ligera que se ve el agua oscura a través de ella. Objeto ancla: la trama bajo el pie.`,
    camara: {
      a: "PLANO DETALLE del pie descalzo apoyándose en la trama, con el agua oscura viéndose entre los hilos.",
      b: "la cámara ha RETROCEDIDO y ha subido hasta un PLANO GENERAL de la balsa entera sobre el río, con ella de pie encima y la araña en un extremo.",
    },
  ...
  esc("b6a", [ref("rio_de_las_almas"), ref("balsa_arana")], {
    comun: "Mirando a través de la trama. Bajo LA MISMA balsa de la referencia, el agua oscura del MISMO río de la referencia lleva reflejos tenues de gente que cruzó antes: siluetas de papel apenas insinuadas, ninguna con cara, pasando por debajo. Objeto ancla: los reflejos bajo el agua.",
    camara: {
      a: "PLANO CENITAL desde encima de la balsa, mirando a través de la trama al agua de abajo.",
      b: "la cámara ha ATRAVESADO la trama y ha bajado hasta el agua misma: PLANO MACRO de la superficie, con los reflejos pasando muy cerca y la balsa como una sombra arriba.",
    },
  ...
  escp("b6b", [ref("tejedora_alma"), ref("balsa_arana"), ref("rio_de_las_almas")], {
    comun: `Luz difusa y fría. ${TEJEDORA} sentada en el centro de LA MISMA balsa de la referencia, con la corriente tirando de la tela por un costado. Es miedo, no pánico: el cuerpo se agarra antes de que la cabeza decida. Objeto ancla: sus manos sobre la trama.`,
    camara: {
      a: "PLANO MEDIO de ella sentada en el centro de la balsa, con el borde levantado en primer término.",
      b: "la cámara se ha ALEJADO y ha subido hasta un GRAN PLANO GENERAL: la balsa es un óvalo pequeño y plateado en mitad de un río enorme.",
    },
  ...
  esc("b7a", [ref("balsa_arana")], {
    comun: "Luz rasante que separa cada hilo: se ven los nudos, los cruces y cómo cada hilo tira de sus vecinos. ÉSTE ES EL PLANO CENTRAL DEL VIDEO y lo que se entiende mirándolo es técnico, no consolador. Objeto ancla: un nudo del centro.",
    camara: {
      a: "PLANO MACRO DENTRO de la trama, con los nudos y los cruces llenando el cuadro.",
      b: "la cámara ha RETROCEDIDO despacio sin salir de la trama: PLANO MEDIO en el que se ve cómo el entramado entero trabaja junto y hacia dónde va cada hilo.",
    },
  ...
  escp("b7b", [ref("tejedora_alma"), ref("telar_marco")], {
    comun: `Luz difusa. La cara de ${TEJEDORA}, de tres cuartos, mirando hacia abajo, hacia la trama que tiene bajo las manos. Es el reconocimiento de un oficio: ella ya sabe cómo se hace esto. Objeto ancla: su mirada.`,
    camara: {
      a: "PRIMER PLANO de su cara de tres cuartos mirando hacia abajo.",
      b: "la cámara ha BAJADO hasta lo que ella mira: PLANO CENITAL de la trama bajo sus manos, con su cara fuera de campo.",
    },
  ...
  esc("b8a", [ref("poblado_nuevo"), ref("sabana_cultivos"), ref("sendero_territorio")], {
    comun: "Sol nuevo bajo y tibio que entra rasante. La otra orilla: un territorio parecido al de ella y sin embargo nuevo, con EL MISMO poblado de la referencia, LOS MISMOS campos preparados de la referencia y varios caminos que salen hacia provincias distintas. No es un premio ni un castigo: es un sitio donde se vive. Objeto ancla: los caminos que se reparten.",
    camara: {
      a: "PLANO MEDIO desde el filo de la ribera, con la niebla baja tapando lo que hay delante.",
      b: "la cámara ha AVANZADO atravesando la niebla y ha subido: GRAN PLANO GENERAL en picado del territorio entero, con el poblado, los campos y los caminos repartiéndose hacia el fondo.",
    },
  ...
  escp("b8b", [ref("familias_muiscas"), ref("sabana_cultivos"), ref("semillas_bolsita")], {
    comun: "Luz tibia del sol nuevo. Gente de LAS MISMAS familias de la referencia en el borde de una parcela con sus términos señalados por piedras; nadie espera inmóvil: hay quien carga, quien habla, quien va de paso. Objeto ancla: LA MISMA bolsita de semillas de la referencia.",
    camara: {
      a: "PLANO GENERAL del borde de la parcela con la gente repartida y las piedras de lindero.",
      b: "la cámara ha AVANZADO entre ellos hasta la bolsita: PLANO DETALLE de las manos que se la pasan, con las figuras cortadas por los bordes.",
    },
  ...
  escp("b9a", [ref("tejedora_alma"), ref("sabana_cultivos"), ref("semillas_bolsita")], {
    comun: `Luz tibia y rasante. ${TEJEDORA} agachada sobre un surco recién abierto en LOS MISMOS campos de la referencia, con la bolsita en una mano. Las mismas manos de tejedora, haciendo ahora otra cosa. Objeto ancla: su mano derecha.`,
    camara: {
      a: "PLANO MACRO sobre el surco, con las semillas cayendo muy cerca del objetivo.",
      b: "la cámara ha RETROCEDIDO y ha subido hasta un PLANO GENERAL del campo: se la ve agachada, pequeña, y el surco entero que lleva sembrado.",
    },
  ...
  escp("b9b", [ref("tejedora_alma"), ref("telar_marco"), ref("balsa_arana")], {
    comun: `Luz tibia del sol nuevo que entra de lado. ${TEJEDORA} de pie, girada hacia atrás, mirando hacia donde vino; en el aire, a media altura y hecha de los mismos hilos plateados, se lee una TRAMA de vida enlazada con otras: hilos que salen de ella y se cruzan con hilos que vienen de otros. No hay río ni barranco detrás: hay tejido. Objeto ancla: los cruces de la trama.`,
    camara: {
      a: "PLANO MEDIO de ella de pie, girada hacia atrás, con un hilo plateado bajando por el borde del cuadro.",
      b: "la cámara ha RETROCEDIDO y ha subido hasta un GRAN PLANO GENERAL final: la trama de hilos se ve entera y enorme en el aire sobre el territorio, con ella pequeña debajo.",
    },

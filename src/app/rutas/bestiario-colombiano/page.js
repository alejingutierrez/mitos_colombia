...
export async function generateMetadata() {
  const seo = await getSeoEntry("route", "bestiario-colombiano");
  return buildSeoMetadata({
    fallback: {
      title: "Bestiario colombiano | Mitos de Colombia",
      description:
        "Criaturas que advierten, transforman y cuidan territorios en la tradición oral colombiana.",
      keywords: ["bestiario", "criaturas", "mitos colombianos", "transformación"],
    },
    seo,
    canonicalPath: "/rutas/bestiario-colombiano",
  });
}

...
export async function generateMetadata() {
  const seo = await getSeoEntry("route", "cartografia-selva");
  return buildSeoMetadata({
    fallback: {
      title: "Cartografía de la selva | Mitos de Colombia",
      description:
        "Mitos que explican caminos, límites y pactos con la tierra en la selva colombiana.",
      keywords: ["selva", "cartografía", "mitos colombianos", "territorio"],
    },
    seo,
    canonicalPath: "/rutas/cartografia-selva",
  });
}

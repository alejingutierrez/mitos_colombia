/**
 * Barrel de templates del sistema de diseño (rediseño 2026).
 * Plantillas de página completas que ensamblan organismos.
 */
export { MythDetailTemplate } from "./MythDetailTemplate";
export { HomeTemplate } from "./HomeTemplate";
export { TarotTemplate } from "./TarotTemplate";

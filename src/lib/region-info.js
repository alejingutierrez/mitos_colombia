...
export const REGION_INFO = {
  amazonas: {
    ...
    description:
      ...
      {
        title: "El territorio",
        body: "La región amazónica colombiana es un vasto territorio de selva tropical que alberga una extraordinaria diversidad de pueblos indígenas, cada uno con complejas tradiciones mitológicas.",
      },
      {
        title: "Su mitología",
        body: "Los Yukuna, Tanimuka, Uitoto, Desano, Barasana, Andoque y muchos otros pueblos han preservado durante milenios relatos sobre el origen del mundo, la creación de los seres humanos mediante anacondas ancestrales, y las transformaciones míticas que establecieron el orden cultural. La mitología amazónica está profundamente conectada con la selva, los ríos, y los espíritus que habitan estos espacios.",
      },
      {
        title: "Lo que transmiten sus mitos",
        body: "Temas recurrentes incluyen viajes entre mundos, ceremonias de maloca, el uso sagrado de plantas como la coca y el tabaco, y enseñanzas sobre el manejo sostenible de recursos. Los mitos amazónicos transmiten profundos conocimientos ecológicos sobre uno de los ecosistemas más complejos del planeta.",
      },
    ],
longDescription:
  ...
  andina: {
    ...
    description:
      ...
      {
        title: "El territorio",
        body: "La región andina colombiana, dominada por las cordilleras de los Andes, ha sido el hogar de importantes civilizaciones como los Muiscas, Catíos, U'wa, Guambianos y Nasa. Esta región presenta una rica fusión de mitologías indígenas prehispánicas y elementos introducidos durante la colonia, creando un sincretismo único.",
      },
      {
        title: "Su mitología",
        body: "Los Muiscas desarrollaron una compleja religión centrada en Chiminigagua (creador), Bachué (madre de la humanidad), Bochica (héroe civilizador) y Chía (diosa lunar). Las lagunas de alta montaña, como Guatavita e Iguaque, son consideradas sagradas y escenario de importantes mitos cosmogónicos.",
      },
      {
        title: "Lo que transmiten sus mitos",
        body: "La mitología andina incluye relatos sobre el origen del sol, la luna, el maíz y otras plantas cultivadas, así como enseñanzas sobre organización social, agricultura en terrazas y el manejo del agua en ecosistemas de montaña. El mestizaje cultural ha dado origen a nuevas narrativas que combinan elementos católicos con tradiciones indígenas.",
      },
    ],
longDescription:
  ...
  caribe: {
    ...
    description:
      ...
      {
        title: "El territorio",
        body: "La región Caribe colombiana, que se extiende por la costa del mar Caribe y las estribaciones de la Sierra Nevada de Santa Marta, es un territorio de extraordinaria diversidad cultural. Los pueblos Wayuu, Kogui, Arhuaco, Wiwa y Kankuamo han preservado tradiciones ancestrales, mientras que comunidades afrodescendientes y mestizas han desarrollado sus propias narrativas.",
      },
      {
        title: "Su mitología",
        body: "Los Kogui de la Sierra Nevada consideran este territorio el 'Corazón del Mundo' y tienen elaborados mitos sobre la Madre Universal y el equilibrio ecológico. Los Wayuu, en la península de La Guajira, tienen una rica tradición oral con relatos sobre Maleiwa, Pulowi y Juyá.",
      },
      {
        title: "Lo que transmiten sus mitos",
        body: "La región también es rica en leyendas mestizas sobre espíritus del agua (la Llorona, el Hombre Caimán), apariciones y transformaciones. El sincretismo cultural ha producido festividades y narrativas únicas que combinan elementos indígenas, africanos y católicos.",
      },
    ],
longDescription:
  ...
  orinoquia: {
    ...
    description:
      ...
      {
        title: "El territorio",
        body: "La Orinoquía colombiana, conocida como los Llanos Orientales, es una extensa región de sabanas tropicales surcadas por ríos que se inundan estacionalmente. Pueblos indígenas como los Sikuani, Kuiva, Kurripaco y otros han desarrollado mitologías adaptadas a este ecosistema único.",
      },
      {
        title: "Su mitología",
        body: "Los mitos llaneros incluyen relatos sobre Kuwai y otros héroes culturales que transformaron el paisaje, crearon los ríos y establecieron prácticas culturales. Las narrativas explican el origen de animales característicos de la sabana como el chigüiro, el venado y diversas aves.",
      },
      {
        title: "Lo que transmiten sus mitos",
        body: "La mitología de la Orinoquía también incluye conocimientos sobre navegación de ríos y caños, manejo de ganado cimarrón, y la importancia de las ceremonias de rezo. Los pueblos llaneros han desarrollado profundos conocimientos sobre los ciclos de inundación y sequía que caracterizan este ecosistema.",
      },
    ],
longDescription:
  ...
  pacifico: {
    ...
    description:
      ...
      {
        title: "El territorio",
        body: "La región Pacífico colombiana, caracterizada por su alta pluviosidad y densa selva tropical, es hogar de pueblos indígenas como los Nasa (Páez), Emberá y Awá, así como de numerosas comunidades afrodescendientes que llegaron durante el período colonial.",
      },
      {
        title: "Su mitología",
        body: "Los Nasa tienen una rica tradición mitológica que combina elementos andinos y de selva tropical, con relatos sobre héroes culturales, la resistencia contra la opresión, y la importancia de mantener el equilibrio con la naturaleza. Las comunidades afrodescendientes del Pacífico han desarrollado narrativas propias que combinan elementos africanos, indígenas y católicos, incluyendo creencias sobre espíritus del monte, la tunda, el riviel y otras entidades sobrenaturales.",
      },
      {
        title: "Lo que transmiten sus mitos",
        body: "La región tiene una fuerte tradición oral transmitida a través de cantos, décimas y arrullos. Los mitos del Pacífico frecuentemente enfatizan temas de libertad, resistencia cultural y la profunda conexión espiritual con la selva y el mar.",
      },
    ],
longDescription:
  ...
  varios: {
    ...
    description:
      ...
      {
        title: "Qué agrupa",
        body: "La categoría 'Varios' agrupa mitos que no se limitan a una región específica, sino que son compartidos por múltiples pueblos, han viajado entre regiones, o representan temas universales de la mitología colombiana.",
      },
      {
        title: "Qué relatos entran",
        body: "Estos relatos pueden incluir narrativas que se encuentran en diferentes versiones a lo largo del país, mitos sobre fenómenos naturales que ocurren en todo el territorio, o enseñanzas morales que trascienden fronteras culturales. También incluye mitos mestizos que han circulado ampliamente, adaptándose a diferentes contextos regionales.",
      },
      {
        title: "Por qué existe esta puerta",
        body: "Esta categoría refleja la interconexión entre las diversas tradiciones mitológicas colombianas y muestra cómo ciertos temas y motivos narrativos aparecen recurrentemente en diferentes pueblos y regiones, sugiriendo tanto intercambios culturales históricos como preocupaciones humanas universales sobre el origen del mundo, la moral y la relación con la naturaleza.",
      },
    ],
longDescription:
...
/**
 * Bloques con título para la cédula de la región. Si todavía no tiene
 * `sections` escritas, se sirve su texto largo como un solo bloque.
 */
export function regionSections(slug, fallbackLong) {
  const info = REGION_INFO[slug];
  if (info?.sections?.length) return info.sections;
  const texto = info?.longDescription || fallbackLong;
  return texto ? [{ title: "La región", body: texto }] : [];
}
